...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP sp_aseo_zonas_list pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION sp_aseo_zonas_list() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

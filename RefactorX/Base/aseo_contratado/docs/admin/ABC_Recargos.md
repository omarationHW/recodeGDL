...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Recargos**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Recargos
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Recargos
...
### Tabla Principal
- **ta_16_recargos**: Tabla principal que maneja este módulo
...
### Operaciones SQL
Este módulo realiza operaciones: Select, Insert, Update, Delete

### Tablas que Afecta
Modifica registros en: ta_16_recargos
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Recargos
...
- **Cons_Recargos**: Módulo de consulta del mismo catálogo
- **Rep_Recargos**: Módulo de reportes del mismo catálogo

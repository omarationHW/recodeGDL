...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Recaudadoras**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Recaudadoras
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Recaudadoras
...
### Operaciones SQL
El módulo interactúa con datos a través de componentes de acceso
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Recaudadoras
...
- **Cons_Recaudadoras**: Módulo de consulta del mismo catálogo
- **Rep_Recaudadoras**: Módulo de reportes del mismo catálogo

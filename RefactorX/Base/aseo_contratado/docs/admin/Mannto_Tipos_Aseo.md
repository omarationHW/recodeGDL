...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Tipos Aseo**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Tipos Aseo
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Tipos Aseo
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Tipos_Aseo
...
- **Cons_Tipos_Aseo**: Módulo de consulta del mismo catálogo
- **Rep_Tipos_Aseo**: Módulo de reportes del mismo catálogo

-- =====================================================================
-- DEPLOYMENT SCRIPT: Vistas y Stored Procedures para Cementerios
...
-- =====================================================================
-- PASO 1: CREAR VISTAS NECESARIAS
-- =====================================================================
...
BEGIN
    ...
    IF p_operacion = 'A' THEN
        ...
        FROM public.v_tc_13_cementerios
    ...
    IF p_operacion = 'B' THEN
        ...
        DELETE FROM public.tc_13_cementerios
        WHERE cementerio = p_cementerio;
    ...
    IF p_operacion = 'C' THEN
        ...
        UPDATE public.tc_13_cementerios
...
BEGIN
    ...
    -- Verificar que el folio existe en ta_13_cem400
...
CREATE OR REPLACE FUNCTION public.sp_cem_buscar_folio_pagos(p_control_id integer)
RETURNS TABLE(
    control_id integer,
...
CREATE OR REPLACE FUNCTION public.sp_cem_listar_pagos_folio(p_control_id integer)
RETURNS TABLE(
    recibo integer,
    fecha date,
    axo_desde integer,
...
BEGIN
    ...
    WHERE p.control_id = p_control_id
...
CREATE OR REPLACE FUNCTION public.sp_cem_obtener_adeudos_pendientes(
    p_control_id integer DEFAULT NULL::integer
)

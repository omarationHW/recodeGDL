...
-- Formulario: RptReq_Aseo
-- Generado: 2025-08-27 15:06:17
-- Total SPs: 2
-- ============================================

-- SP 1/2: rptreq_aseo_report
-- Tipo: Report
-- Descripción: Obtiene los adeudos de aseo contratado para un rango de folios y una oficina recaudadora.
-- --------------------------------------------

CREATE OR REPLACE FUNCTION rptreq_aseo_report(
    p_ofna integer,
    p_folio1 integer,
    p_folio2 integer
)
...
BEGIN
    RETURN QUERY
    SELECT a.control_contrato, a.num_contrato, a.ctrol_aseo, a.num_empresa, a.ctrol_emp, a.ctrol_recolec, a.cantidad_recolec,
           a.domicilio, a.sector, a.ctrol_zona, a.id_rec, a.fecha_hora_alta, a.status_vigencia, a.aso_mes_oblig, a.cve, a.usuario, a.fecha_hora_baja,
           b.id_control, b.zona, b.modulo, b.control_otr, b.folio, b.diligencia, b.importe_global, b.importe_multa, b.importe_recargo, b.importe_gastos,
           b.zona_apremio, b.fecha_emision, b.clave_practicado, b.fecha_practicado, b.fecha_entrega1, b.fecha_entrega2, b.fecha_citatorio, b.hora,
           b.ejecutor, b.clave_secuestro, b.clave_remate, b.fecha_remate, b.porcentaje_multa, b.observaciones, b.fecha_pago, b.recaudadora, b.caja,
           b.operacion, b.importe_pago, b.vigencia, b.fecha_actualiz, b.usuario as usuario_1, b.clave_mov, b.hora_practicado,
...
-- SP 2/2: rptreq_aseo_recaudadora
-- Tipo: Catalog

...
-- Archivo: 04_SP_ESTACIONAMIENTOS_CGAARCEDOEX_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 3 (EXACTO)
-- ============================================
...
BEGIN
    ...
    -- Simulación:
    UPDATE public.ta14_datos_edo SET teso_cve = 'AFECTADO' WHERE fecharemesa = p_fecha AND teso_cve IS NULL;

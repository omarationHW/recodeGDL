...
-- Formulario: ConsGral (EXACTO del archivo original)
-- Archivo: 05_SP_ESTACIONAMIENTOS_CONSGRAL_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 2 (EXACTO)
-- ============================================
...
BEGIN
    ...
    JOIN public.ta14_fol_banorte d ON d.axo = c.axo AND d.folio = c.folio

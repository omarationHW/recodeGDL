-- Stored Procedure: sp_get_ade_energia_grl
-- Tipo: Report
...
-- Generado para formulario: RptAdeEnergiaGrl
-- Fecha: 2025-08-27 00:36:29
...
BEGIN
    ...
    LOOP
        ...
        cad := '';
        cuota_val := 0;
        FOR m IN SELECT periodo, importe FROM ta_11_adeudo_energ WHERE id_energia = r.id_energia AND axo = r.axo AND periodo <= p_mes ORDER BY periodo LOOP
            cad := cad || m.periodo || '-';
            cuota_val := m.importe;
        END LOOP;

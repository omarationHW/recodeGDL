...
BEGIN
    ...
    JOIN comun.ta_11_mercados b ON b.oficina = a.oficina AND b.num_mercado_nvo = a.num_mercado
    ...
    JOIN comun.ta_11_mercados i ON i.oficina = g.oficina AND i.num_mercado_nvo = g.num_mercado
    ...
    JOIN comun.ta_11_mercados f ON f.oficina = d.oficina AND f.num_mercado_nvo = d.num_mercado

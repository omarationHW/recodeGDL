...
BEGIN
    ...
    INNER JOIN ta_11_cuo_locales c ON c.axo = p_year AND c.categoria = l.categoria AND c.seccion = l.seccion AND c.clave_cuota = l.clave_cuota
    LEFT JOIN (
    ...
    LEFT JOIN ta_11_fecha_desc fd ON fd.mes = p_month

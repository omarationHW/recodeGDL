...
-- Formulario: CargaPagosTexto
-- Generado: 2025-08-26 22:59:53
-- Total SPs: 1
-- ============================================

-- SP 1/1: sp_importar_pago_texto
-- Tipo: CRUD
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_exists FROM public.ta_11_pagos_local
    ...
    SELECT COUNT(*) INTO v_adeudo_exists FROM public.ta_11_adeudo_local
    WHERE id_local = p_id_local AND axo = p_axo AND periodo = p_periodo;

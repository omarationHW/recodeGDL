...
- **QryCondonados**: Consulta para obtenciÃ³n de datos
- **QryLocal**: Consulta para obtenciÃ³n de datos

## Stored Procedures
- **SpdAdeudos**: Procedimiento almacenado para procesamiento de datos

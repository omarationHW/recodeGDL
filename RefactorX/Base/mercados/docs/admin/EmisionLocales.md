...
**PropÃ³sito:** MÃ³dulo de emisiÃ³n de documentos del sistema de Mercados de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de mercados municipales y tiene como objetivo MÃ³dulo de emisiÃ³n de documentos.toLowerCase().
...
- **QryGrabaAdeudo**: Consulta para obtenciÃ³n de datos
- **QryEmision**: Consulta para obtenciÃ³n de datos
- **QryAdeudo**: Consulta para obtenciÃ³n de datos
- **QryAdeudolocal**: Consulta para obtenciÃ³n de datos
- **QryEmisionLaser**: Consulta para obtenciÃ³n de datos
- **QryPagos**: Consulta para obtenciÃ³n de datos
- **QryRecarMes**: Consulta para obtenciÃ³n de datos
- **QryFecDes**: Consulta para obtenciÃ³n de datos
...
**MÃ³dulo:** EmisionLocales.pas
**CategorÃ­a del Sistema:** EmisiÃ³n

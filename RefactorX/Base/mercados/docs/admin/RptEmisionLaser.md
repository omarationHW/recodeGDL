...
**PropÃ³sito:** MÃ³dulo de generaciÃ³n de reportes del sistema de Mercados de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de mercados municipales y tiene como objetivo MÃ³dulo de generaciÃ³n de reportes.toLowerCase().
...
- **QrySubT**: Consulta para obtenciÃ³n de datos
...
**MÃ³dulo:** RptEmisionLaser.pas
**CategorÃ­a del Sistema:** Reportes
**Tablas identificadas:** 0 tabla(s)
**Consultas identificadas:** 7 consulta(s)

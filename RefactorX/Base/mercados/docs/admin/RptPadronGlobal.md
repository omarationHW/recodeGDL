...
### Consultas (TQuery)
- **QryPadron**: Consulta para obtenciÃ³n de datos
- **QryAdeudos**: Consulta para obtenciÃ³n de datos
- **QryCalcrenta**: Consulta para obtenciÃ³n de datos
- **QryVencimientoRec**: Consulta para obtenciÃ³n de datos

...
### Consultas (TQuery)
- **QryMaestro**: Consulta para obtenciÃ³n de datos
- **QryBancoActivo**: Consulta para obtenciÃ³n de datos
- **QryCtaTrans**: Consulta para obtenciÃ³n de datos

<template>
  <div class="container-fluid mt-4">
    <div class="alert alert-info" role="alert">
      <h4 class="alert-heading">💰 Req</h4>
      <p>Este componente está en desarrollo y será implementado próximamente.</p>
      <hr>
      <p class="mb-0">
        <small><strong>Módulo:</strong> Recaudadora | <strong>Componente:</strong> Req</small>
      </p>
    </div>
    
    <div class="card">
      <div class="card-header bg-light">
        <h5 class="mb-0">Req</h5>
      </div>
      <div class="card-body">
        <p class="text-muted">
...
export default {
  ...
  mounted() {
    console.log('Componente Req montado (placeholder)');
  }
}
</script>

...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_actualiza_fechas pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_actualiza_fechas() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

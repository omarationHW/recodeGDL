...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_bloqctasreqfrm pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_bloqctasreqfrm() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_bloqueo_multa pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_bloqueo_multa() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

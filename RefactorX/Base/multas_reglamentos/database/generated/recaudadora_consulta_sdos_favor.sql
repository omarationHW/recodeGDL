...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_consulta_sdos_favor pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_consulta_sdos_favor() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

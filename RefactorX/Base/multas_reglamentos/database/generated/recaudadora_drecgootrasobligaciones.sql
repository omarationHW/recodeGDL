-- ================================================================
-- SP: recaudadora_drecgootrasobligaciones
-- Módulo: multas_reglamentos
-- Descripción: Consulta información de contribuyentes y derechos de otras obligaciones
-- Autor: Sistema RefactorX
-- Fecha: 2025-12-01
-- ================================================================

CREATE OR REPLACE FUNCTION multas_reglamentos.recaudadora_drecgootrasobligaciones(
...
AS $$
BEGIN
    -- Buscar contribuyentes relacionados con otras obligaciones
...
-- Comentario del SP
COMMENT ON FUNCTION multas_reglamentos.recaudadora_drecgootrasobligaciones(VARCHAR) IS 'Consulta información de contribuyentes y derechos de otras obligaciones desde comun.contrib';

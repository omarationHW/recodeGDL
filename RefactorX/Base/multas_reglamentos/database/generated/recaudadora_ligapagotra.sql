...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_ligapagotra pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_ligapagotra() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

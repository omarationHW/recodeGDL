...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_pagosmultfrm pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_pagosmultfrm() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

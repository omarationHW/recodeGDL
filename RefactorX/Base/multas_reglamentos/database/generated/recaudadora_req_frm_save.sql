...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_req_frm_save pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_req_frm_save() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

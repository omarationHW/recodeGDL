...
BEGIN
  ...
  SELECT jsonb_build_object(
    'success', true,
    'message', 'SP recaudadora_sdosfavor_ctrlexp pendiente de implementación',
    'data', '[]'::jsonb
  );
...
-- Comentario del SP
COMMENT ON FUNCTION recaudadora_sdosfavor_ctrlexp() IS 'SP generado automáticamente - REQUIERE IMPLEMENTACIÓN';

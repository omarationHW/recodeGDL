...
### Consultas (TQuery)
- **QryUltFolio**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryGeneraFolio**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryImpresion**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryListado**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryCuenta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **SpGenera**: Procedimiento almacenado para procesamiento de datos
- **SpAfecta**: Procedimiento almacenado para procesamiento de datos
- **SpSeleccion**: Procedimiento almacenado para procesamiento de datos
- **SpDotacion**: Procedimiento almacenado para procesamiento de datos
- **SpAsigna**: Procedimiento almacenado para procesamiento de datos

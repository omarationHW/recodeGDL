...
**CategorÃ­a:** Cancelaciones

**PropÃ³sito:** MÃ³dulo de cancelaciÃ³n de documentos del sistema de RecaudaciÃ³n de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de recaudaciÃ³n catastral y tiene como objetivo MÃ³dulo de cancelaciÃ³n de documentos.toLowerCase().
...
- **ReacudQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **BuscaFolQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **EjecutoresQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **ReasignaSP**: Procedimiento almacenado para procesamiento de datos
- **AsignaSP**: Procedimiento almacenado para procesamiento de datos
...
### Casos Especiales
- Cancelaciones requieren autorizaciÃ³n de supervisor
- Se requiere justificaciÃ³n documentada
...
**MÃ³dulo:** canc.pas
**CategorÃ­a del Sistema:** Cancelaciones

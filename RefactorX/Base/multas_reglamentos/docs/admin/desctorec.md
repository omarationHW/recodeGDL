...
### Tablas Principales
- **descrec**: Tabla principal del mÃ³dulo
- **descmult**: Tabla principal del mÃ³dulo
- **pagos**: Tabla principal del mÃ³dulo
- **autorizamulta**: Tabla principal del mÃ³dulo

### Consultas (TQuery)
- **Qry_st_descrec**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryImporte**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query2**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query1**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_st_saldos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_tiene_convenio**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_con_saldo**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_altadesc_rec**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_canc_descrec**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **qry_descmulta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_req**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **qry_alta_descmulta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Qry_canc_descMulta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **qry_cierre_periodo**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

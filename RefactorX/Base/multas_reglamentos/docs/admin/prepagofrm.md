...
**PropÃ³sito:** MÃ³dulo de registro y control de pagos del sistema de RecaudaciÃ³n de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de recaudaciÃ³n catastral y tiene como objetivo MÃ³dulo de registro y control de pagos.toLowerCase().
...
- Datos del pago (importe, fecha, forma de pago)
...
- **ultreqpredQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **tienereqQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **nolaborQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **difdesctosQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **UltcvedesctoQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **conveniosQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryReqcitado**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QrySaldosafavor**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query4**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryBloq**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryBuenFinNormal**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QrySinPromocion**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- ... y 4 consultas adicionales

## Stored Procedures
- **del_dppSP**: Procedimiento almacenado para procesamiento de datos
- **calc_dppSP**: Procedimiento almacenado para procesamiento de datos
- **calc_descpredSP**: Procedimiento almacenado para procesamiento de datos
- **Strd_Rec**: Procedimiento almacenado para procesamiento de datos

## Impacto y Repercusiones

### Registros Afectados
- Tabla de **pagos**: Registro de transacciones
- ActualizaciÃ³n de saldos y adeudos
- AfectaciÃ³n de cuentas por cobrar
...
**MÃ³dulo:** prepagofrm.pas
**CategorÃ­a del Sistema:** Pagos
**Tablas identificadas:** 0 tabla(s)
**Consultas identificadas:** 19 consulta(s)

...
### Tablas Principales
- **prescrip**: Tabla principal del mÃ³dulo

### Consultas (TQuery)
- **detsaldos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **h_catastroQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **StoredProc1**: Procedimiento almacenado para procesamiento de datos
- **Ult_comprobSP**: Procedimiento almacenado para procesamiento de datos

...
**Tipo de ObligaciÃ³n:** General

**PropÃ³sito:** MÃ³dulo de carga de datos del sistema de Otras Obligaciones de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de Otras Obligaciones Fiscales y tiene como objetivo MÃ³dulo de carga de datos.toLowerCase() para el control y administraciÃ³n de obligaciones fiscales diversas del municipio.
...
- **QryUnidades**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryIns_Valores**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryMax**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
...
### Casos Especiales
- Carga masiva requiere validaciÃ³n previa del archivo
- Proceso de respaldo antes de carga masiva
- Rollback en caso de error durante la carga
...
**MÃ³dulo:** CargaValores.pas
**CategorÃ­a del Sistema:** Carga
**Tipo:** General

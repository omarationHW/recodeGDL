-- ============================================
-- STORED PROCEDURES - consultausuariosfrm (FINAL)
-- Base: padron_licencias
-- Esquema: comun
-- Fecha: 2025-11-04
-- CORRECCION: Tipos exactos + alias para evitar ambigüedad
-- ============================================
...
-- ============================================
-- CREAR FUNCIONES CON TIPOS CORRECTOS
-- ============================================
...
BEGIN
    RETURN QUERY
    SELECT t.id_dependencia, t.descripcion, t.abrevia
...
BEGIN
    RETURN QUERY
    SELECT t.cvedepto, t.nombredepto, t.telefono, t.cvedependencia
    FROM comun.deptos t
...
SELECT '✅ Script completado - 9 SPs en esquema comun (FINAL)' as status;

-- ============================================
-- FIX: Agregar campos nivel y cvedepto a los SPs
-- Base: padron_licencias
-- Esquema: comun
-- Fecha: 2025-11-04
-- PROBLEMA: Falta campo nivel y cvedepto en RETURNS TABLE
-- SOLUCIÓN: Agregar ambos campos a todos los SPs de consulta
-- ============================================
...
-- ============================================
-- RECREAR FUNCIONES CON NIVEL Y CVEDEPTO
-- ============================================
...
SELECT '✅ Script completado - campos nivel y cvedepto agregados' as status;

-- ============================================
-- RECREAR STORED PROCEDURES - consultausuariosfrm
-- Base: padron_licencias
-- Esquema: comun
-- Fecha: 2025-11-04
-- PASO 1: DROP funciones existentes
-- PASO 2: CREATE con tipos de datos correctos
-- ============================================
...
SELECT '✅ Script completado - 9 SPs recreados en esquema comun con tipos correctos' as status;

...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Cves Operacion**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Cves Operacion
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Cves Operacion
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Cves_Operacion
...
- **Cons_Cves_Operacion**: Módulo de consulta del mismo catálogo
- **Rep_Cves_Operacion**: Módulo de reportes del mismo catálogo

...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Und Recolec**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Und Recolec
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Und Recolec
...
### Tablas que Afecta
Modifica registros en: ta_16_Unidades
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Und_Recolec
...
- **Cons_Und_Recolec**: Módulo de consulta del mismo catálogo
- **Rep_Und_Recolec**: Módulo de reportes del mismo catálogo

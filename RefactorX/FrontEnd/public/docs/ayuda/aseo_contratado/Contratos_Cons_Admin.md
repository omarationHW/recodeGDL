...
### Descripción
Módulo de consulta del catálogo de **Contratos Admin**. Permite visualizar la información registrada sin capacidad de modificación.

## Proceso de Negocio

### ¿Qué hace?
- Presenta una vista de consulta del catálogo de Contratos Admin

...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Gastos**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Gastos
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Gastos
...
### Tabla Principal
- **ta_16_gastos**: Tabla principal que maneja este módulo
...
### Operaciones SQL
Este módulo realiza operaciones: Delete

### Tablas que Afecta
Modifica registros en: ta_16_gastos
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Gastos
...
- **Cons_Gastos**: Módulo de consulta del mismo catálogo
- **Rep_Gastos**: Módulo de reportes del mismo catálogo

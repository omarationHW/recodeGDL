...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Operaciones**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Operaciones
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Operaciones
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Operaciones
...
- **Cons_Operaciones**: Módulo de consulta del mismo catálogo
- **Rep_Operaciones**: Módulo de reportes del mismo catálogo

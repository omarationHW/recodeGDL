...
### Descripción
Permite realizar operaciones de Alta, Baja y Modificación sobre el catálogo de **Zonas**. Este módulo es fundamental para mantener actualizada la información maestra del sistema.

## Proceso de Negocio

### ¿Qué hace?
1. Presenta una interfaz de consulta del catálogo de Zonas
...
### ¿Para qué sirve?
- Mantener actualizado el catálogo de Zonas
...
## Casos de Uso
1. **Alta de nuevo registro**: Usuario administrativo da de alta un nuevo elemento en el catálogo de Zonas
...
- **Cons_Zonas**: Módulo de consulta del mismo catálogo
- **Rep_Zonas**: Módulo de reportes del mismo catálogo

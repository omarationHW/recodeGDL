...
### Descripción
Módulo de generación de reportes sobre **Recaudadoras**. Produce documentos impresos o visualizables con información consolidada.

## Proceso de Negocio

### ¿Qué hace?
- Genera reportes formateados sobre Recaudadoras
...
- **Administrativos**: Personal que genera reportes operativos

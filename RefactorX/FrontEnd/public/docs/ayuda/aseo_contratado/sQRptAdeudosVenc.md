...
### Descripción
Módulo de generación de reportes sobre **AdeudosVenc**. Produce documentos impresos o visualizables con información consolidada.

## Proceso de Negocio

### ¿Qué hace?
- Genera reportes formateados sobre AdeudosVenc
...
- **ta_16_pagos**: Tabla relacionada utilizada en el módulo
- **ta_16_recargos**: Tabla relacionada utilizada en el módulo

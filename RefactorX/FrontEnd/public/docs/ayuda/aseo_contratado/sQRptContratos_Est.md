...
### Descripción
Módulo de generación de reportes sobre **Contratos Est**. Produce documentos impresos o visualizables con información consolidada.

## Proceso de Negocio

### ¿Qué hace?
- Genera reportes formateados sobre Contratos Est
...
### Tabla Principal
- **ta_16_contratos**: Tabla principal que maneja este módulo

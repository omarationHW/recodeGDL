...
### Consultas (TQuery)
- **QryAdeGlobal**: Consulta para obtención de datos
- **QryMerc**: Consulta para obtención de datos
- **QryRequerimiento**: Consulta para obtención de datos
- **QryLocalPag**: Consulta para obtención de datos
- **QryAccesorios**: Consulta para obtención de datos

...
### Consultas (TQuery)
- **QryGrabaPagos**: Consulta para obtención de datos
- **QryMerc**: Consulta para obtención de datos
- **QryChecaPago**: Consulta para obtención de datos
- **QrychecaLocal**: Consulta para obtención de datos
- **QryLeeAdeudos**: Consulta para obtención de datos

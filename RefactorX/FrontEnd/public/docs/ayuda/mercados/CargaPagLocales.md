...
**Propósito:** Módulo de captura y carga de datos del sistema de Mercados de Guadalajara.
...
Este módulo forma parte del sistema integral de gestión de mercados municipales y tiene como objetivo Módulo de captura y carga de datos.toLowerCase().
...
- **QryCargaPagos**: Consulta para obtención de datos
...
- **QryBorrarAdeudos**: Consulta para obtención de datos
- **QryCaja**: Consulta para obtención de datos
- **QryfechaDesc**: Consulta para obtención de datos
- **QryIngreso**: Consulta para obtención de datos
- **QryCaptura**: Consulta para obtención de datos
- ... y 3 consultas adicionales
...
### Casos Especiales
- La carga masiva requiere validación de formato de archivo
...
**Módulo:** CargaPagLocales.pas
**Categoría del Sistema:** Captura
**Tablas identificadas:** 0 tabla(s)
**Consultas identificadas:** 13 consulta(s)

...
### Consultas (TQuery)
- **QryCargaPagos**: Consulta para obtenciÃ³n de datos
...
- **QryBorrarAdeudos**: Consulta para obtenciÃ³n de datos
- **QryCaja**: Consulta para obtenciÃ³n de datos
- **QryfechaDesc**: Consulta para obtenciÃ³n de datos
- **QryIngreso**: Consulta para obtenciÃ³n de datos
- **QryCaptura**: Consulta para obtenciÃ³n de datos
- **Qrydiasinhabil**: Consulta para obtenciÃ³n de datos
...
### Casos Especiales
- La carga masiva requiere validaciÃ³n de formato de archivo

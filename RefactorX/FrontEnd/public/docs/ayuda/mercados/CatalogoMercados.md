...
**Propósito:** Módulo de administración de catálogos del sistema de Mercados de Guadalajara.
...
Este módulo forma parte del sistema integral de gestión de mercados municipales y tiene como objetivo Módulo de administración de catálogos.toLowerCase().
...
### Consultas (TQuery)
- **QryCatalogo**: Consulta para obtención de datos
...
**Módulo:** CatalogoMercados.pas
**Categoría del Sistema:** Catálogos

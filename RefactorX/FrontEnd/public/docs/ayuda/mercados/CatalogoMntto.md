...
### Consultas (TQuery)
- **QryRec**: Consulta para obtención de datos
- **QryZonas**: Consulta para obtención de datos
- **QryCatalogoMntto**: Consulta para obtención de datos
- **QryCat**: Consulta para obtención de datos

...
### Consultas (TQuery)
- **QryRec**: Consulta para obtenciÃ³n de datos
- **QryZonas**: Consulta para obtenciÃ³n de datos
- **QryCatalogoMntto**: Consulta para obtenciÃ³n de datos
- **QryCat**: Consulta para obtenciÃ³n de datos
...
### Registros Afectados
- Tabla **ta_11_mercados**: CatÃ¡logo de mercados municipales

...
**Propósito:** Módulo de consulta de información del sistema de Mercados de Guadalajara.
...
Este módulo forma parte del sistema integral de gestión de mercados municipales y tiene como objetivo Módulo de consulta de información.toLowerCase().
...
- **QryPeriodos**: Consulta para obtención de datos
- **QryLocales**: Consulta para obtención de datos
- **QryEjecutor**: Consulta para obtención de datos
- **QryClaves**: Consulta para obtención de datos
- **QryDilClaves**: Consulta para obtención de datos
- **QryPraClaves**: Consulta para obtención de datos
- **QryDescMulta**: Consulta para obtención de datos

...
- **QryEnergiaMtto**: Consulta para obtención de datos
- **QryMerc**: Consulta para obtención de datos
- **QryEnergia**: Consulta para obtención de datos
- **QryLeerEnergia**: Consulta para obtención de datos
- **QryMovimientoMtto**: Consulta para obtención de datos
- **QryBorrar**: Consulta para obtención de datos
- **QryAdeudoMtto**: Consulta para obtención de datos
- **QryElimina**: Consulta para obtención de datos
- **QryChecaCambio**: Consulta para obtención de datos

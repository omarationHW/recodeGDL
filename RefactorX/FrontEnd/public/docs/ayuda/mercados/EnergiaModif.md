...
- **QryEnergiaMtto**: Consulta para obtenciÃ³n de datos
- **QryMerc**: Consulta para obtenciÃ³n de datos
- **QryEnergia**: Consulta para obtenciÃ³n de datos
- **QryLeerEnergia**: Consulta para obtenciÃ³n de datos
- **QryMovimientoMtto**: Consulta para obtenciÃ³n de datos
- **QryBorrar**: Consulta para obtenciÃ³n de datos
- **QryAdeudoMtto**: Consulta para obtenciÃ³n de datos
- **QryElimina**: Consulta para obtenciÃ³n de datos
- **QryChecaCambio**: Consulta para obtenciÃ³n de datos

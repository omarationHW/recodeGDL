...
### Consultas (TQuery)
- **QryCtaConcilia**: Consulta para obtenciÃ³n de datos
- **QryDatConcilia**: Consulta para obtenciÃ³n de datos
- **QryUpdCtaConcilia**: Consulta para obtenciÃ³n de datos

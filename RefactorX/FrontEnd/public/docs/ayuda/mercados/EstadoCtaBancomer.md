...
### Consultas (TQuery)
- **QryCtaConcilia**: Consulta para obtención de datos
- **QryDatConcilia**: Consulta para obtención de datos
- **QryUpdCtaConcilia**: Consulta para obtención de datos

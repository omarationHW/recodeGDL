...
**CategorÃ­a:** ModificaciÃ³n

**PropÃ³sito:** MÃ³dulo de modificaciÃ³n de registros del sistema de Mercados de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de mercados municipales y tiene como objetivo MÃ³dulo de modificaciÃ³n de registros.toLowerCase().
...
### Consultas (TQuery)
- **QryZona**: Consulta para obtenciÃ³n de datos
- **QryLocales**: Consulta para obtenciÃ³n de datos
- **QryCuota**: Consulta para obtenciÃ³n de datos
- **QryMovimiento**: Consulta para obtenciÃ³n de datos
- **QryLocalesMtto**: Consulta para obtenciÃ³n de datos
- **QryMerc**: Consulta para obtenciÃ³n de datos
- **QryClaveMov**: Consulta para obtenciÃ³n de datos
- **QryBorrar**: Consulta para obtenciÃ³n de datos
- **QryAdeudoMtto**: Consulta para obtenciÃ³n de datos
- **QryRenta**: Consulta para obtenciÃ³n de datos
...
### Casos Especiales
- Modificaciones requieren autorizaciÃ³n especial
...
**MÃ³dulo:** LocalesModif.pas
**CategorÃ­a del Sistema:** ModificaciÃ³n

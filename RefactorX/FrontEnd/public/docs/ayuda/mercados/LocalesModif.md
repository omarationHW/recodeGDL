...
**Propósito:** Módulo de modificación de registros del sistema de Mercados de Guadalajara.
...
Este módulo forma parte del sistema integral de gestión de mercados municipales y tiene como objetivo Módulo de modificación de registros.toLowerCase().
...
- Datos del local comercial (mercado, categoría, número)
- Información del propietario o arrendatario
...
### Consultas (TQuery)
- **QryZona**: Consulta para obtención de datos
- **QryLocales**: Consulta para obtención de datos
- **QryCuota**: Consulta para obtención de datos
- **QryMovimiento**: Consulta para obtención de datos
- **QryLocalesMtto**: Consulta para obtención de datos
- **QryMerc**: Consulta para obtención de datos
- **QryClaveMov**: Consulta para obtención de datos
- **QryBorrar**: Consulta para obtención de datos
- **QryAdeudoMtto**: Consulta para obtención de datos
- **QryRenta**: Consulta para obtención de datos
- ... y 8 consultas adicionales

## Stored Procedures
- **genadeudos**: Procedimiento almacenado para procesamiento de datos
- **spget_lic_estatus**: Procedimiento almacenado para procesamiento de datos
- **Traspaso**: Procedimiento almacenado para procesamiento de datos
...
### Casos Especiales
- Modificaciones requieren autorización especial
...
### Permisos Necesarios
- **Nivel requerido:** Supervisor o Administrador
...
**Módulo:** LocalesModif.pas
**Categoría del Sistema:** Modificación

...
**Propósito:** Módulo de mantenimiento de catálogos del sistema de Mercados de Guadalajara.
...
Este módulo forma parte del sistema integral de gestión de mercados municipales y tiene como objetivo Módulo de mantenimiento de catálogos.toLowerCase().
...
- **QryPermisos**: Consulta para obtención de datos
...
**Módulo:** LocalesMtto.pas
**Categoría del Sistema:** Mantenimiento

...
**PropÃ³sito:** MÃ³dulo de conexiÃ³n a base de datos del sistema de Mercados de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de mercados municipales y tiene como objetivo MÃ³dulo de conexiÃ³n a base de datos.toLowerCase().
...
### Consultas (TQuery)
- **QryFecha**: Consulta para obtenciÃ³n de datos
- **QryRec**: Consulta para obtenciÃ³n de datos
- **QrySec**: Consulta para obtenciÃ³n de datos
- **QryCaja**: Consulta para obtenciÃ³n de datos
...
- **QryVersiones**: Consulta para obtenciÃ³n de datos
...
**MÃ³dulo:** ModuloBD.pas
**CategorÃ­a del Sistema:** Principal

...
- **QryLicencias**: Consulta para obtenciÃ³n de datos
- **QryReqLic**: Consulta para obtenciÃ³n de datos

## Stored Procedures
- **spget_lic_estatus**: Procedimiento almacenado para procesamiento de datos
- **lic_datosconv**: Procedimiento almacenado para procesamiento de datos

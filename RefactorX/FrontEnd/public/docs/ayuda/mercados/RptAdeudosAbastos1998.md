...
### Consultas (TQuery)
- **QryRenta1998**: Consulta para obtención de datos
- **QryAdeudos1998**: Consulta para obtención de datos
- **QryMesAdeudo1998**: Consulta para obtención de datos
...
**Módulo:** RptAdeudosAbastos1998.pas

...
### Consultas (TQuery)
- **QryEmisionAbastos**: Consulta para obtención de datos
- **QryMesAdeudoAbastos**: Consulta para obtención de datos
- **QryPagosAbastos**: Consulta para obtención de datos
- **QryRecarMesAbastos**: Consulta para obtención de datos
...
**Módulo:** RptEmisionRbosAbastos.pas

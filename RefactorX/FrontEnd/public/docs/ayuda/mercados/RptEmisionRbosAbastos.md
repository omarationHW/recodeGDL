...
### Consultas (TQuery)
- **QryEmisionAbastos**: Consulta para obtenciÃ³n de datos
- **QryMesAdeudoAbastos**: Consulta para obtenciÃ³n de datos
- **QryPagosAbastos**: Consulta para obtenciÃ³n de datos
- **QryRecarMesAbastos**: Consulta para obtenciÃ³n de datos
...
**MÃ³dulo:** RptEmisionRbosAbastos.pas

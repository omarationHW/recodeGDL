...
### Consultas (TQuery)
- **QryMaestro**: Consulta para obtención de datos
- **QryBancoActivo**: Consulta para obtención de datos
- **QryCtaTrans**: Consulta para obtención de datos

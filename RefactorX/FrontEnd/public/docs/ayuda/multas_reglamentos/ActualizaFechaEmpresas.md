...
- **QryBuscaFolio**: Consulta para obtención/actualización de datos
- **QryAfectaFecPrac**: Consulta para obtención/actualización de datos
...
**Módulo:** ActualizaFechaEmpresas.pas

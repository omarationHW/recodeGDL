...
**Categoría:** Saldos a Favor

**Propósito:** Módulo de gestión de saldos a favor del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo de gestión de saldos a favor.toLowerCase().
...
### Consultas (TQuery)
- **busca_sol**: Consulta para obtención/actualización de datos
- **convcta**: Consulta para obtención/actualización de datos
- **contrib**: Consulta para obtención/actualización de datos
- **SdosFavorQry**: Consulta para obtención/actualización de datos
- **Aplica_PagFavorQry**: Consulta para obtención/actualización de datos
- **sdosFAplica**: Consulta para obtención/actualización de datos
- **detSaldosQry**: Consulta para obtención/actualización de datos
- **selecDetSalQry**: Consulta para obtención/actualización de datos
- **importeQry**: Consulta para obtención/actualización de datos
- **pagosQry**: Consulta para obtención/actualización de datos
- **PagosSdosQry**: Consulta para obtención/actualización de datos
- **tienereqQry**: Consulta para obtención/actualización de datos
- **x**: Consulta para obtención/actualización de datos
...
**Módulo:** AplicaSdosFavor.pas
**Categoría del Sistema:** Saldos a Favor

...
### Consultas (TQuery)
- **norequeribleQry**: Consulta para obtención/actualización de datos
- **localizaQry**: Consulta para obtención/actualización de datos
- **listaQry**: Consulta para obtención/actualización de datos
- **reqlicenciaQry**: Consulta para obtención/actualización de datos
- **lista_hQry**: Consulta para obtención/actualización de datos
- **noReqQry1**: Consulta para obtención/actualización de datos
- **dataSEt**: Consulta para obtención/actualización de datos
- **dataSet**: Consulta para obtención/actualización de datos

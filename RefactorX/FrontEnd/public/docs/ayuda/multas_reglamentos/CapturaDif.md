...
### Consultas (TQuery)
- **diferencias**: Consulta para obtención/actualización de datos
- **FolioTrans**: Consulta para obtención/actualización de datos
- **PeritoQry**: Consulta para obtención/actualización de datos
- **DeptosQry**: Consulta para obtención/actualización de datos
- **NotQry**: Consulta para obtención/actualización de datos
- **PagosQry**: Consulta para obtención/actualización de datos

## Stored Procedures
- **ActualizaSP**: Procedimiento almacenado para procesamiento de datos
- **recargosSP**: Procedimiento almacenado para procesamiento de datos

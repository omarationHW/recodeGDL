...
### Consultas (TQuery)
- **QryUltFolio**: Consulta para obtención/actualización de datos
- **QryGeneraFolio**: Consulta para obtención/actualización de datos
- **QryImpresion**: Consulta para obtención/actualización de datos
- **QryListado**: Consulta para obtención/actualización de datos
- **QryCuenta**: Consulta para obtención/actualización de datos

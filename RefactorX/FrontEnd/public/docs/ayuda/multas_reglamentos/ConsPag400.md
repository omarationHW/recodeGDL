...
### Consultas (TQuery)
- **ConsPag400**: Consulta para obtención/actualización de datos
- **trasp_400Qry**: Consulta para obtención/actualización de datos
- **obscan_400Qry**: Consulta para obtención/actualización de datos

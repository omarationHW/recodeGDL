...
### Consultas (TQuery)
- **generalesQry**: Consulta para obtención/actualización de datos
...
- **GetParcISP**: Procedimiento almacenado para procesamiento de datos
- **FechaSP**: Procedimiento almacenado para procesamiento de datos

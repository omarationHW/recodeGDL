...
- **QryAutoriza**: Consulta para obtención/actualización de datos
...
- **buscaActualizacionQry**: Consulta para obtención/actualización de datos
- **descActualizacionTransQry**: Consulta para obtención/actualización de datos
...
**Módulo:** DescMultaReqDifTrans.pas

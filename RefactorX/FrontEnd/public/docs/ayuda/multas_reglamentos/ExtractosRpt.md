...
### Tablas Principales
- **valmodif1**: Tabla principal del mÃ³dulo
- **valmodif2**: Tabla principal del mÃ³dulo
- **actos**: Tabla principal del mÃ³dulo
- **actos2**: Tabla principal del mÃ³dulo

### Consultas (TQuery)
- **Qryextractos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **liquidacionQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **saldosxctaQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryextracAdq**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query1**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query2**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryextracTrans**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **liqxaxoQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
...
- **extracxctasQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **comprobQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **valmodif**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **ActualizacionQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **MultaQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

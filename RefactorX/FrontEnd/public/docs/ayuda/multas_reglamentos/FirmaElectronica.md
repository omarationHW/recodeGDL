...
### Consultas (TQuery)
- **QryDatosFEA**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **Sp_GeneraFirma**: Procedimiento almacenado para procesamiento de datos
- **Sp_FoliosFirmaLic**: Procedimiento almacenado para procesamiento de datos
- **ins_reqlicenciafea**: Procedimiento almacenado para procesamiento de datos

...
**Propósito:** Módulo de impresión de documentos del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo de impresión de documentos.toLowerCase().
...
**Módulo:** ImpresionNva.pas
**Categoría del Sistema:** Impresión

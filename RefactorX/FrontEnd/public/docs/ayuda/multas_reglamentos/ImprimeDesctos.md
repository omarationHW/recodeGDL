...
### Tablas Principales
- **foliosdesc**: Tabla principal del módulo

### Consultas (TQuery)
- **descMultaQry**: Consulta para obtención/actualización de datos
- **ContribQry**: Consulta para obtención/actualización de datos
- **recaudQry**: Consulta para obtención/actualización de datos
- **DescuentosQry**: Consulta para obtención/actualización de datos
- **DescMultaMpalQry**: Consulta para obtención/actualización de datos
- **UpdFolio**: Consulta para obtención/actualización de datos
- **cancDescQry**: Consulta para obtención/actualización de datos
- **multasQry**: Consulta para obtención/actualización de datos
- **AutorizaQry**: Consulta para obtención/actualización de datos
- **desctosMpalQry**: Consulta para obtención/actualización de datos
- **cancDescMpalQry**: Consulta para obtención/actualización de datos
- **descMultaTransQry**: Consulta para obtención/actualización de datos
- **desctosTranQry**: Consulta para obtención/actualización de datos
- **cancDesctranQry**: Consulta para obtención/actualización de datos
- **QryDescrec**: Consulta para obtención/actualización de datos

# LicenciaMicrogeneradorEcologia
...
### Consultas (TQuery)
- **QryTramite**: Consulta para obtención/actualización de datos
- **QryLicencias**: Consulta para obtención/actualización de datos

## Stored Procedures
- **Sp_Microgenerador**: Procedimiento almacenado para procesamiento de datos
...
**Módulo:** LicenciaMicrogeneradorEcologia.pas

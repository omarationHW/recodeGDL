...
### Consultas (TQuery)
- **recQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **SelecQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryEjecutor**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **SprcConvenios**: Procedimiento almacenado para procesamiento de datos
- **Sp_PagosConvEmpresas**: Procedimiento almacenado para procesamiento de datos

...
### Consultas (TQuery)
- **QryFolios**: Consulta para obtención/actualización de datos
- **QryEjec**: Consulta para obtención/actualización de datos
- **QrySinAdeud**: Consulta para obtención/actualización de datos
- **Qrypagos**: Consulta para obtención/actualización de datos
- **Qrymodfi**: Consulta para obtención/actualización de datos
- **QryMultas**: Consulta para obtención/actualización de datos
- **QrySinAdeudM**: Consulta para obtención/actualización de datos
...
- **QrySinAdeudoL**: Consulta para obtención/actualización de datos
- **Query3**: Consulta para obtención/actualización de datos
- **QrySinAdeudoA**: Consulta para obtención/actualización de datos
- **QryAnuncios**: Consulta para obtención/actualización de datos
- **Query4**: Consulta para obtención/actualización de datos
- ... y 5 consultas adicionales
...
**Módulo:** ModifMasiva.pas
**Categoría del Sistema:** General
**Tablas identificadas:** 0 tabla(s)
**Consultas identificadas:** 20 consulta(s)

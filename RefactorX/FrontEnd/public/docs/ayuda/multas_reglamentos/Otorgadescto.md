...
- **DescMultas**: Consulta para obtención/actualización de datos
- **c_dependencias**: Consulta para obtención/actualización de datos
- **AutorizamultaQry**: Consulta para obtención/actualización de datos
- **verificautorizaqry**: Consulta para obtención/actualización de datos
- **QryHistoria**: Consulta para obtención/actualización de datos
- **QryLista**: Consulta para obtención/actualización de datos

...
### Tablas Principales
- **Autpagoesp**: Tabla principal del módulo

### Consultas (TQuery)
- **borraautQry**: Consulta para obtención/actualización de datos
- **QryConsulta**: Consulta para obtención/actualización de datos
- **QryVigentes**: Consulta para obtención/actualización de datos
- **QryCancela**: Consulta para obtención/actualización de datos

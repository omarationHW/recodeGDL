...
- **Diferencias**: Tabla principal del módulo

### Consultas (TQuery)
- **c_movctaQry**: Consulta para obtención/actualización de datos
- **h_uemQry**: Consulta para obtención/actualización de datos
- **obs400Qry**: Consulta para obtención/actualización de datos
- **cfs400Qry**: Consulta para obtención/actualización de datos
- **escritQry**: Consulta para obtención/actualización de datos
- **condominioQry**: Consulta para obtención/actualización de datos
- **QryPag400**: Consulta para obtención/actualización de datos

...
**PropÃ³sito:** MÃ³dulo relacionado con licencias del sistema de RecaudaciÃ³n de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de recaudaciÃ³n catastral y tiene como objetivo MÃ³dulo relacionado con licencias.toLowerCase().
...
### Consultas (TQuery)
- **Qry_esta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryAdeudos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryCategoria**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Ins_Porcentaje**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryPub_EliminaDescuentos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryPermiso**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryFuncionarios**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryDescuentos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryFuncionariosMulta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Ins_PorcentajeMulta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryPub_EliminaDescuentosMulta**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryDescuentosMul**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **sp_conspredio**: Procedimiento almacenado para procesamiento de datos
...
**MÃ³dulo:** Publicos_Upd.pas
**CategorÃ­a del Sistema:** Licencias
**Tablas identificadas:** 0 tabla(s)
**Consultas identificadas:** 12 consulta(s)

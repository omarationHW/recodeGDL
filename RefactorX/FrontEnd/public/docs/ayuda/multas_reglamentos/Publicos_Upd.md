...
### Consultas (TQuery)
- **Qry_esta**: Consulta para obtención/actualización de datos
- **QryAdeudos**: Consulta para obtención/actualización de datos
- **QryCategoria**: Consulta para obtención/actualización de datos
- **Ins_Porcentaje**: Consulta para obtención/actualización de datos
- **QryPub_EliminaDescuentos**: Consulta para obtención/actualización de datos
...
- **QryPub_EliminaDescuentosMulta**: Consulta para obtención/actualización de datos
- **QryDescuentosMul**: Consulta para obtención/actualización de datos

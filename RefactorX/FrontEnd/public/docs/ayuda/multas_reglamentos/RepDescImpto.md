...
### Consultas (TQuery)
- **GeneralQry**: Consulta para obtención/actualización de datos
- **RecaudQry**: Consulta para obtención/actualización de datos
- **TipoDesQry**: Consulta para obtención/actualización de datos
- **ReactivaQry**: Consulta para obtención/actualización de datos

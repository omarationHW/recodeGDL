...
### Tablas Principales
- **convcta**: Tabla principal del módulo
- **recaud**: Tabla principal del módulo
- **articulos**: Tabla principal del módulo
...
- **reqpredial**: Consulta para obtención/actualización de datos
- **UbicacionQry**: Consulta para obtención/actualización de datos
- **contribQry**: Consulta para obtención/actualización de datos
- **control**: Consulta para obtención/actualización de datos
- **detreqpredial**: Consulta para obtención/actualización de datos
- **RegPropQry**: Consulta para obtención/actualización de datos
- **compqry**: Consulta para obtención/actualización de datos
- **notificadoQry**: Consulta para obtención/actualización de datos
- **reqmultaQry**: Consulta para obtención/actualización de datos
- **C_EjecutoresQry**: Consulta para obtención/actualización de datos
- **n_EjecutoresQry**: Consulta para obtención/actualización de datos
- **UpdEjecutorQry**: Consulta para obtención/actualización de datos

...
### Consultas (TQuery)
- **Ejec_ImpQry**: Consulta para obtención/actualización de datos
- **ImprimeReqQry**: Consulta para obtención/actualización de datos
- **QryRec**: Consulta para obtención/actualización de datos
- **detreqpredial**: Consulta para obtención/actualización de datos
- **Grabaimpreso**: Consulta para obtención/actualización de datos
- **Query1**: Consulta para obtención/actualización de datos
- **Qryperiodo**: Consulta para obtención/actualización de datos
- **QryEstadis**: Consulta para obtención/actualización de datos
- **Query2**: Consulta para obtención/actualización de datos
- **QryInforme**: Consulta para obtención/actualización de datos
- **Qryperiodo1**: Consulta para obtención/actualización de datos
- **QryPlazo**: Consulta para obtención/actualización de datos
- **Query3**: Consulta para obtención/actualización de datos
- **QryPeriodoNvoFmt**: Consulta para obtención/actualización de datos
- **QryUltimaNOT**: Consulta para obtención/actualización de datos

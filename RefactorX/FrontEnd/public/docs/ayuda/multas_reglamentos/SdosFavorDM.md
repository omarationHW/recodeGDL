...
### Tablas Principales
- **pagosTbl**: Tabla principal del módulo
- **folios**: Tabla principal del módulo

### Consultas (TQuery)
- **pagosAplQry**: Consulta para obtención/actualización de datos
- **PagosQry**: Consulta para obtención/actualización de datos
- **autorizaQry**: Consulta para obtención/actualización de datos
- **SelecFoliosQry**: Consulta para obtención/actualización de datos
- **cancSol**: Consulta para obtención/actualización de datos
- **validaIns**: Consulta para obtención/actualización de datos
- **porFolio**: Consulta para obtención/actualización de datos
- **Query1**: Consulta para obtención/actualización de datos
- **Sol_sdosFavorQry**: Consulta para obtención/actualización de datos
...
**Módulo:** SdosFavorDM.pas
**Categoría del Sistema:** Saldos a Favor
**Tablas identificadas:** 2 tabla(s)

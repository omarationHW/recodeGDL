...
### Tablas Principales
- **descpred**: Tabla principal del módulo
- **contrib**: Tabla principal del módulo
- **regprop**: Tabla principal del módulo
- **foliodesc**: Tabla principal del módulo
- **instituciones**: Tabla principal del módulo
- **valoradeudo**: Tabla principal del módulo
...
- **saldoQry**: Consulta para obtención/actualización de datos
- **Query3**: Consulta para obtención/actualización de datos
- **RespaldoQry**: Consulta para obtención/actualización de datos
- **borraReg**: Consulta para obtención/actualización de datos
- **InsRespQry**: Consulta para obtención/actualización de datos

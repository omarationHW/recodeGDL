...
### Tablas Principales
- **descpred**: Tabla principal del mÃ³dulo
- **contrib**: Tabla principal del mÃ³dulo
- **regprop**: Tabla principal del mÃ³dulo
- **foliodesc**: Tabla principal del mÃ³dulo
- **instituciones**: Tabla principal del mÃ³dulo
- **valoradeudo**: Tabla principal del mÃ³dulo
...
- **saldoQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query3**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **RespaldoQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **borraReg**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **InsRespQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

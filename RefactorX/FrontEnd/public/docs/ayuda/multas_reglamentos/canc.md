...
**Propósito:** Módulo de cancelación de documentos del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo de cancelación de documentos.toLowerCase().
...
- **ReacudQry**: Consulta para obtención/actualización de datos
- **BuscaFolQry**: Consulta para obtención/actualización de datos
...
- Se requiere justificación documentada
...
**Módulo:** canc.pas
**Categoría del Sistema:** Cancelaciones

...
### Tablas Principales
- **reccentros**: Tabla principal del módulo

### Consultas (TQuery)
- **depQry**: Consulta para obtención/actualización de datos
- **capturaQry**: Consulta para obtención/actualización de datos
- **multasTbl**: Consulta para obtención/actualización de datos
- **pagoQry**: Consulta para obtención/actualización de datos

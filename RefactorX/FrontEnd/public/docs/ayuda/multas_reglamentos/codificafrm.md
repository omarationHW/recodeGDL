...
- **codifica**: Tabla principal del módulo

### Consultas (TQuery)
- **DatoscontQry**: Consulta para obtención/actualización de datos
- **listadoQry**: Consulta para obtención/actualización de datos

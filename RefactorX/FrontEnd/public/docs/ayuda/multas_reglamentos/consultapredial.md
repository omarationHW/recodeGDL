...
**PropÃ³sito:** MÃ³dulo de consulta de informaciÃ³n del sistema de RecaudaciÃ³n de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de recaudaciÃ³n catastral y tiene como objetivo MÃ³dulo de consulta de informaciÃ³n.toLowerCase().
...
### Tablas Principales
- **TNatActos**: Tabla principal del mÃ³dulo
- **dgacto**: Tabla principal del mÃ³dulo
- **TAvaluosTrans**: Tabla principal del mÃ³dulo
- **tblpagos**: Tabla principal del mÃ³dulo
- **Table1**: Tabla principal del mÃ³dulo
- **ejecutores**: Tabla principal del mÃ³dulo

### Consultas (TQuery)
- **detpagoQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **c_movctaQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **pagadosQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **bmxQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **pagreqQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **condominioQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryModif**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryIncon**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryAfavor**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryDesctoPred**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryDesctoRec**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryDesctoMul**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **TransmisQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **AdquirientesQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **ReqTransQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

...
**Propósito:** Módulo relacionado con licencias del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo relacionado con licencias.toLowerCase().
...
### Consultas (TQuery)
- **buscalicQry**: Consulta para obtención/actualización de datos
- **descmultaTransQry**: Consulta para obtención/actualización de datos
- **QryActualiza**: Consulta para obtención/actualización de datos
- **Query1**: Consulta para obtención/actualización de datos
- **buscanunQry**: Consulta para obtención/actualización de datos
- **Query2**: Consulta para obtención/actualización de datos
- **buscaForQry**: Consulta para obtención/actualización de datos
- **QryFuncionarios**: Consulta para obtención/actualización de datos
- **BuscaSubsidioQry**: Consulta para obtención/actualización de datos

## Stored Procedures
- **StrdPrcAplica**: Procedimiento almacenado para procesamiento de datos
- **StrdPrcLicGral**: Procedimiento almacenado para procesamiento de datos
...
**Módulo:** dderechosLic.pas
**Categoría del Sistema:** Licencias

...
### Consultas (TQuery)
- **licenciaqry**: Consulta para obtención/actualización de datos
- **DescMultaslic**: Consulta para obtención/actualización de datos
- **QryFolio**: Consulta para obtención/actualización de datos

...
### Consultas (TQuery)
- **c_descpredQry**: Consulta para obtención/actualización de datos
- **query2**: Consulta para obtención/actualización de datos
- **descpredQry**: Consulta para obtención/actualización de datos
- **contribQry**: Consulta para obtención/actualización de datos
- **institucionesQry**: Consulta para obtención/actualización de datos
- **AutorizaQry**: Consulta para obtención/actualización de datos
- **ValoradeudoQry**: Consulta para obtención/actualización de datos
- **QryTramites**: Consulta para obtención/actualización de datos
- **ActivaQry**: Consulta para obtención/actualización de datos
- **RelacionQry**: Consulta para obtención/actualización de datos
- **FolioQry**: Consulta para obtención/actualización de datos
- **reactivaQryAl**: Consulta para obtención/actualización de datos
- **TasasQry**: Consulta para obtención/actualización de datos
- **ConsReacQry**: Consulta para obtención/actualización de datos
- **ConReaQry**: Consulta para obtención/actualización de datos
- ... y 2 consultas adicionales

## Stored Procedures
- **Adeudos_StdP**: Procedimiento almacenado para procesamiento de datos
- **FechaSis_SP**: Procedimiento almacenado para procesamiento de datos
- **Modif_periSP**: Procedimiento almacenado para procesamiento de datos

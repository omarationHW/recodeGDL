...
**Propósito:** Módulo de cálculo de recargos del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo de cálculo de recargos.toLowerCase().
...
- **QryDescMultaLic**: Consulta para obtención/actualización de datos
- **QryFuncRecargos**: Consulta para obtención/actualización de datos
...
**Módulo:** drecgoLic.pas
**Categoría del Sistema:** Recargos

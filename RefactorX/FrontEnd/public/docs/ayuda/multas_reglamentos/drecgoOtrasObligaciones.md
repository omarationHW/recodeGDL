...
### Consultas (TQuery)
- **desObligacionesQry**: Consulta para obtención/actualización de datos
- **Query1**: Consulta para obtención/actualización de datos
- **QryObligacion**: Consulta para obtención/actualización de datos
...
**Módulo:** drecgoOtrasObligaciones.pas

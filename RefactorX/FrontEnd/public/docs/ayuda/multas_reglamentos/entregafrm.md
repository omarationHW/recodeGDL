...
**Propósito:** Formulario de captura/consulta del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Formulario de captura/consulta.toLowerCase().
...
### Tablas Principales
- **reqpredial**: Tabla principal del módulo
- **unreqpred**: Tabla principal del módulo
- **reqmultas**: Tabla principal del módulo
- **unreqmulta**: Tabla principal del módulo

### Consultas (TQuery)
- **ejecutoresQry**: Consulta para obtención/actualización de datos
- **updreqQry**: Consulta para obtención/actualización de datos
...
- **pagosMulta**: Consulta para obtención/actualización de datos
- **multas_ejecut**: Consulta para obtención/actualización de datos
- **multas_plazoQry**: Consulta para obtención/actualización de datos
- **entregaReqQry**: Consulta para obtención/actualización de datos
- **nReqQry**: Consulta para obtención/actualización de datos
...
**Módulo:** entregafrm.pas
**Categoría del Sistema:** Formularios
**Tablas identificadas:** 4 tabla(s)
**Consultas identificadas:** 10 consulta(s)

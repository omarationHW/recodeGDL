...
- **emitidosQry**: Consulta para obtención/actualización de datos
- **practQry**: Consulta para obtención/actualización de datos
- **nodilQry**: Consulta para obtención/actualización de datos
- **pagadoQry**: Consulta para obtención/actualización de datos
- **cancQry**: Consulta para obtención/actualización de datos
- **recaudQry**: Consulta para obtención/actualización de datos
- **practxvigQry**: Consulta para obtención/actualización de datos
- **nodilxvigQry**: Consulta para obtención/actualización de datos
- **emitidosxvigQry**: Consulta para obtención/actualización de datos
- **gaspagQry**: Consulta para obtención/actualización de datos

## Stored Procedures
- **tmp_gaspagSP**: Procedimiento almacenado para procesamiento de datos

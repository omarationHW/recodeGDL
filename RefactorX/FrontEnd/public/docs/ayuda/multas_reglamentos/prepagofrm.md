...
**Propósito:** Módulo de registro y control de pagos del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo de registro y control de pagos.toLowerCase().
...
- **tienereqQry**: Consulta para obtención/actualización de datos
- **nolaborQry**: Consulta para obtención/actualización de datos
- **difdesctosQry**: Consulta para obtención/actualización de datos
- **UltcvedesctoQry**: Consulta para obtención/actualización de datos
- **conveniosQry**: Consulta para obtención/actualización de datos
- **QryReqcitado**: Consulta para obtención/actualización de datos
- **QrySaldosafavor**: Consulta para obtención/actualización de datos
- **Query4**: Consulta para obtención/actualización de datos
- **QryBloq**: Consulta para obtención/actualización de datos
- **QryBuenFinNormal**: Consulta para obtención/actualización de datos
- **QrySinPromocion**: Consulta para obtención/actualización de datos
...
**Módulo:** prepagofrm.pas
**Categoría del Sistema:** Pagos

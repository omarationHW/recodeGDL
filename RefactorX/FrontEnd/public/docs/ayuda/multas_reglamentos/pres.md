...
### Tablas Principales
- **prescrip**: Tabla principal del módulo

### Consultas (TQuery)
- **detsaldos**: Consulta para obtención/actualización de datos
- **h_catastroQry**: Consulta para obtención/actualización de datos

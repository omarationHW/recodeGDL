...
### Tablas Principales
- **tmp_adeudolic**: Tabla principal del módulo

### Consultas (TQuery)
- **Query1**: Consulta para obtención/actualización de datos
- **Query2**: Consulta para obtención/actualización de datos
- **reciboQry**: Consulta para obtención/actualización de datos
- **convcta1Qry**: Consulta para obtención/actualización de datos
- **Query3**: Consulta para obtención/actualización de datos
- **ultreqpredQry**: Consulta para obtención/actualización de datos
- **QryLicencia**: Consulta para obtención/actualización de datos
- **mensQry**: Consulta para obtención/actualización de datos
- **detSalLicQry**: Consulta para obtención/actualización de datos

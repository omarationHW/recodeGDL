...
### Tablas Principales
- **consultaDependencia**: Tabla principal del módulo

### Consultas (TQuery)
- **multasQry**: Consulta para obtención/actualización de datos
- **totalesQry**: Consulta para obtención/actualización de datos
- **dependencias**: Consulta para obtención/actualización de datos
- **infracciones**: Consulta para obtención/actualización de datos
- **multas**: Consulta para obtención/actualización de datos
- **BusMultaPagada**: Consulta para obtención/actualización de datos
- **totMultasPagadas**: Consulta para obtención/actualización de datos
- **auditoria**: Consulta para obtención/actualización de datos
- **porzonaQry**: Consulta para obtención/actualización de datos
- **QryListaMultiple**: Consulta para obtención/actualización de datos
- **QryReq**: Consulta para obtención/actualización de datos
- **QryRecaud**: Consulta para obtención/actualización de datos

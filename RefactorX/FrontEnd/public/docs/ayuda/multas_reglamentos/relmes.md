...
### Tablas Principales
- **consultaDependencia**: Tabla principal del mÃ³dulo

### Consultas (TQuery)
- **multasQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **totalesQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **dependencias**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **infracciones**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **multas**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **BusMultaPagada**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **totMultasPagadas**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **auditoria**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **porzonaQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryListaMultiple**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryReq**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryRecaud**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **Sp_Recaudado**: Procedimiento almacenado para procesamiento de datos
- **Sp_MultasCalificadas**: Procedimiento almacenado para procesamiento de datos

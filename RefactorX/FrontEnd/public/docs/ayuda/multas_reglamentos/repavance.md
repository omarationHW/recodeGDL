...
**Propósito:** Módulo de generación de reportes del sistema de Recaudación de Guadalajara.
...
Este módulo forma parte del sistema integral de recaudación catastral y tiene como objetivo Módulo de generación de reportes.toLowerCase().
...
- **Table2**: Tabla principal del módulo
- **Table3**: Tabla principal del módulo
- **Table4**: Tabla principal del módulo
- **Table5**: Tabla principal del módulo
- **Table6**: Tabla principal del módulo
- **Table7**: Tabla principal del módulo
- **Table8**: Tabla principal del módulo
- **Table9**: Tabla principal del módulo
- **Table10**: Tabla principal del módulo
- **est**: Tabla principal del módulo
- **Table11**: Tabla principal del módulo
- **Table12**: Tabla principal del módulo
- **Table13**: Tabla principal del módulo

### Consultas (TQuery)
- **Query2**: Consulta para obtención/actualización de datos
- **Query3**: Consulta para obtención/actualización de datos
- **Query4**: Consulta para obtención/actualización de datos
- **borra**: Consulta para obtención/actualización de datos
- **Query1**: Consulta para obtención/actualización de datos
- **Query5**: Consulta para obtención/actualización de datos
- **Query6**: Consulta para obtención/actualización de datos
- **q1**: Consulta para obtención/actualización de datos
...
**Módulo:** repavance.pas
**Categoría del Sistema:** Reportes

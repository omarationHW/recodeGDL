...
**PropÃ³sito:** MÃ³dulo de generaciÃ³n de reportes del sistema de RecaudaciÃ³n de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de recaudaciÃ³n catastral y tiene como objetivo MÃ³dulo de generaciÃ³n de reportes.toLowerCase().
...
- **Table2**: Tabla principal del mÃ³dulo
- **Table3**: Tabla principal del mÃ³dulo
- **Table4**: Tabla principal del mÃ³dulo
- **Table5**: Tabla principal del mÃ³dulo
- **Table6**: Tabla principal del mÃ³dulo
- **Table7**: Tabla principal del mÃ³dulo
- **Table8**: Tabla principal del mÃ³dulo
- **Table9**: Tabla principal del mÃ³dulo
- **Table10**: Tabla principal del mÃ³dulo
- **est**: Tabla principal del mÃ³dulo
- **Table11**: Tabla principal del mÃ³dulo
- **Table12**: Tabla principal del mÃ³dulo
- **Table13**: Tabla principal del mÃ³dulo

### Consultas (TQuery)
- **Query2**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query3**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query4**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **borra**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query1**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query5**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **Query6**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **q1**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **proc1**: Procedimiento almacenado para procesamiento de datos
- **proc2**: Procedimiento almacenado para procesamiento de datos
- **proc3**: Procedimiento almacenado para procesamiento de datos
- **proc4**: Procedimiento almacenado para procesamiento de datos
- **proc5**: Procedimiento almacenado para procesamiento de datos
- **proc6**: Procedimiento almacenado para procesamiento de datos
- **proc7**: Procedimiento almacenado para procesamiento de datos
- **proc8**: Procedimiento almacenado para procesamiento de datos
- **proc9**: Procedimiento almacenado para procesamiento de datos
- **proc10**: Procedimiento almacenado para procesamiento de datos
- **proc11**: Procedimiento almacenado para procesamiento de datos
- **Proc12**: Procedimiento almacenado para procesamiento de datos
...
**MÃ³dulo:** repavance.pas
**CategorÃ­a del Sistema:** Reportes
**Tablas identificadas:** 14 tabla(s)
**Consultas identificadas:** 8 consulta(s)
**Stored Procedures:** 12 procedimiento(s)

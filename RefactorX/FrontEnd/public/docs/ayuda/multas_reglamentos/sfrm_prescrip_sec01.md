...
### Consultas (TQuery)
- **Qry_saldos_presc**: Consulta para obtención/actualización de datos
- **qry_solicitud**: Consulta para obtención/actualización de datos
- **qry_gast_mult**: Consulta para obtención/actualización de datos
- **qry_solicprec**: Consulta para obtención/actualización de datos
- **Qry_req_pract**: Consulta para obtención/actualización de datos
- **Qry_datos_cta**: Consulta para obtención/actualización de datos
- **sp_adeudos**: Consulta para obtención/actualización de datos
- **qry_impuesto_total**: Consulta para obtención/actualización de datos
...
**Módulo:** sfrm_prescrip_sec01.pas

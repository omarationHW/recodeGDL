...
- **versionQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **horarioQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **horaQry**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **fechasysSP**: Procedimiento almacenado para procesamiento de datos
- **CasoVinculo**: Procedimiento almacenado para procesamiento de datos
- **SpBuenFin**: Procedimiento almacenado para procesamiento de datos

...
**CategorÃ­a:** ActualizaciÃ³n

**Tipo de ObligaciÃ³n:** Giros (Licencias)

**PropÃ³sito:** MÃ³dulo de actualizaciÃ³n de registros del sistema de Otras Obligaciones de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de Otras Obligaciones Fiscales y tiene como objetivo MÃ³dulo de actualizaciÃ³n de registros.toLowerCase() para el control y administraciÃ³n de obligaciones fiscales diversas del municipio.
...
### Consultas (TQuery)
- **QryPagos**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryTablas**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryDependencias**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryEtiq**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryMultas_Rel**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QrySuspension**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **spcob34_gdatosg_02**: Procedimiento almacenado para procesamiento de datos
- **upd34_gen_unds**: Procedimiento almacenado para procesamiento de datos
- **upd34_gen_sup**: Procedimiento almacenado para procesamiento de datos
- **upd34_gen_oblig**: Procedimiento almacenado para procesamiento de datos
- **upd34_gen_grales**: Procedimiento almacenado para procesamiento de datos
- **sp34_upd_actas**: Procedimiento almacenado para procesamiento de datos
- **Sp_Suspension**: Procedimiento almacenado para procesamiento de datos

## Impacto y Repercusiones

### Registros Afectados
- Tabla de **obligaciones**: ModificaciÃ³n de datos
- ActualizaciÃ³n de importes y periodicidad
- Ajuste de informaciÃ³n del contribuyente
...
**MÃ³dulo:** GActualiza.pas
**CategorÃ­a del Sistema:** ActualizaciÃ³n

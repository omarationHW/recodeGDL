...
- **QryVigencia_Cont**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **Spcon34_gdetade_01**: Procedimiento almacenado para procesamiento de datos
- **sp34_padron**: Procedimiento almacenado para procesamiento de datos

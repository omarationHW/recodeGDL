...
**Tipo de ObligaciÃ³n:** Registro (Otras Obligaciones)

**PropÃ³sito:** MÃ³dulo de baja de registros del sistema de Otras Obligaciones de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de Otras Obligaciones Fiscales y tiene como objetivo MÃ³dulo de baja de registros.toLowerCase() para el control y administraciÃ³n de obligaciones fiscales diversas del municipio.
...
### Consultas (TQuery)
- **QryConcesiones**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryAdeudos_pas**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryAdeudos_post**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **spdel34_rastro_01**: Procedimiento almacenado para procesamiento de datos

## Impacto y Repercusiones

### Registros Afectados
- Tabla de **obligaciones**: Baja de obligaciones
- ActualizaciÃ³n de estatus (activo a baja)
- CancelaciÃ³n de adeudos pendientes

### Documentos Generados
- Reportes impresos con formato oficial
- Listados para supervisiÃ³n y control
- Archivos de exportaciÃ³n (PDF, Excel)
...
### Casos Especiales
- Bajas requieren autorizaciÃ³n de supervisor
- Se requiere justificaciÃ³n documentada de la baja
- ValidaciÃ³n de saldos pendientes antes de dar de baja
...
**MÃ³dulo:** RBaja.pas
**CategorÃ­a del Sistema:** Bajas
**Tipo:** Registro (Otras Obligaciones)

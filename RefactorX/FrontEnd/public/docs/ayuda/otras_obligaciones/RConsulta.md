...
**PropÃ³sito:** MÃ³dulo de consulta de informaciÃ³n del sistema de Otras Obligaciones de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de Otras Obligaciones Fiscales y tiene como objetivo MÃ³dulo de consulta de informaciÃ³n.toLowerCase() para el control y administraciÃ³n de obligaciones fiscales diversas del municipio.
...
- **QryFechaLimite**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **QryPagados**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **spcob34_rdetade_01**: Procedimiento almacenado para procesamiento de datos
- **spcob34_rtotade_01**: Procedimiento almacenado para procesamiento de datos

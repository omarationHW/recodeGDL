...
**PropÃ³sito:** MÃ³dulo de registro de pagos del sistema de Otras Obligaciones de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de Otras Obligaciones Fiscales y tiene como objetivo MÃ³dulo de registro de pagos.toLowerCase() para el control y administraciÃ³n de obligaciones fiscales diversas del municipio.
...
- Datos del pago (folio, fecha, importe)

...
**CategorÃ­a:** CatÃ¡logos

**Tipo de ObligaciÃ³n:** Registro (Otras Obligaciones)

**PropÃ³sito:** MÃ³dulo de catÃ¡logo de rubros del sistema de Otras Obligaciones de Guadalajara.
...
Este mÃ³dulo forma parte del sistema integral de gestiÃ³n de Otras Obligaciones Fiscales y tiene como objetivo MÃ³dulo de catÃ¡logo de rubros.toLowerCase() para el control y administraciÃ³n de obligaciones fiscales diversas del municipio.
...
- **QryStatus_Tablas**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos
- **qryIns_Status**: Consulta para obtenciÃ³n/actualizaciÃ³n de datos

## Stored Procedures
- **spins34_rubro_01**: Procedimiento almacenado para procesamiento de datos
...
**MÃ³dulo:** Rubros.pas
**CategorÃ­a del Sistema:** CatÃ¡logos

...
Este componente proporciona la interfaz para lista gastos cob.
...
- Componente: Lista_GastosCob.vue
- Ruta: /src/views/modules/estacionamiento_exclusivo/Lista_GastosCob.vue

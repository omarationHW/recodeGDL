...
Este componente proporciona la interfaz para rprt estadxfolio.
...
- Componente: RprtEstadxfolio.vue
- Ruta: /src/views/modules/estacionamiento_exclusivo/RprtEstadxfolio.vue

...
Este componente proporciona la interfaz para rprt listax fec.
...
- Componente: RprtListaxFec.vue
- Ruta: /src/views/modules/estacionamiento_exclusivo/RprtListaxFec.vue

...
Este componente proporciona la interfaz para rpt listax reg pub.
...
- Componente: RptListaxRegPub.vue
- Ruta: /src/views/modules/estacionamiento_exclusivo/RptListaxRegPub.vue

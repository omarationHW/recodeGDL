...
Este componente proporciona la interfaz para rpt recup aseo.
...
- Componente: RptRecup_Aseo.vue
- Ruta: /src/views/modules/estacionamiento_exclusivo/RptRecup_Aseo.vue

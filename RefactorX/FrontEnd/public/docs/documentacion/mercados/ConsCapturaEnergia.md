...
Este componente proporciona la interfaz para cons captura energia.
...
- Modulo: mercados
- Componente: ConsCapturaEnergia.vue
- Ruta: /src/views/modules/mercados/ConsCapturaEnergia.vue

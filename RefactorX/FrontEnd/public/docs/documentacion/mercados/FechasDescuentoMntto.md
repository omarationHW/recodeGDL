...
Este componente proporciona la interfaz para fechas descuento mntto.
...
- Modulo: mercados
- Componente: FechasDescuentoMntto.vue
- Ruta: /src/views/modules/mercados/FechasDescuentoMntto.vue

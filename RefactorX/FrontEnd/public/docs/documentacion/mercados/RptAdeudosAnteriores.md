...
Este componente proporciona la interfaz para rpt adeudos anteriores.
...
- Modulo: mercados
- Componente: RptAdeudosAnteriores.vue
- Ruta: /src/views/modules/mercados/RptAdeudosAnteriores.vue

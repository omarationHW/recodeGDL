...
Este componente proporciona la interfaz para aplica sdos favor.
...
- Componente: AplicaSdosFavor.vue
- Ruta: /src/views/modules/multas_reglamentos/AplicaSdosFavor.vue

...
Este componente proporciona la interfaz para carta invitacion.
...
- Componente: CartaInvitacion.vue
- Ruta: /src/views/modules/multas_reglamentos/CartaInvitacion.vue

...
Este componente proporciona la interfaz para desc derechos merc.
...
- Componente: DescDerechosMerc.vue
- Ruta: /src/views/modules/multas_reglamentos/DescDerechosMerc.vue

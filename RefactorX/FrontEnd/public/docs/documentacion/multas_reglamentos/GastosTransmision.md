...
Este componente proporciona la interfaz para gastos transmision.
...
- Componente: GastosTransmision.vue
- Ruta: /src/views/modules/multas_reglamentos/GastosTransmision.vue

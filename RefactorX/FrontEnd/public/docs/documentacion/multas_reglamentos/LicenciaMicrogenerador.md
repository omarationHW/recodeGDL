...
Este componente proporciona la interfaz para licencia microgenerador.
...
- Componente: LicenciaMicrogenerador.vue
- Ruta: /src/views/modules/multas_reglamentos/LicenciaMicrogenerador.vue

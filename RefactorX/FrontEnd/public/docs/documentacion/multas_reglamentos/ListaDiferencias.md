...
Este componente proporciona la interfaz para lista diferencias.
...
- Componente: ListaDiferencias.vue
- Ruta: /src/views/modules/multas_reglamentos/ListaDiferencias.vue

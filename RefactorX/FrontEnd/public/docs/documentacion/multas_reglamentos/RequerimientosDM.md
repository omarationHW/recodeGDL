...
Este componente proporciona la interfaz para requerimientos dm.
...
- Componente: RequerimientosDM.vue
- Ruta: /src/views/modules/multas_reglamentos/RequerimientosDM.vue

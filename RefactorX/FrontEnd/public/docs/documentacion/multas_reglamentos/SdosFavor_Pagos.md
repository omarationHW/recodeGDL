...
Este componente proporciona la interfaz para sdos favor pagos.
...
- Componente: SdosFavor_Pagos.vue
- Ruta: /src/views/modules/multas_reglamentos/SdosFavor_Pagos.vue

...
Este componente proporciona la interfaz para descmultampalfrm.
...
- Componente: descmultampalfrm.vue
- Ruta: /src/views/modules/multas_reglamentos/descmultampalfrm.vue

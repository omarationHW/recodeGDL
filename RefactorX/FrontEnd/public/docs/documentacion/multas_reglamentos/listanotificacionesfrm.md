...
Este componente proporciona la interfaz para listanotificacionesfrm.
...
- Componente: listanotificacionesfrm.vue
- Ruta: /src/views/modules/multas_reglamentos/listanotificacionesfrm.vue

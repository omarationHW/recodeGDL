...
Este componente proporciona la interfaz para listdesctomultafrm.
...
- Componente: listdesctomultafrm.vue
- Ruta: /src/views/modules/multas_reglamentos/listdesctomultafrm.vue

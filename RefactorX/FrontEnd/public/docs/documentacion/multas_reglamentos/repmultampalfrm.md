...
Este componente proporciona la interfaz para repmultampalfrm.
...
- Componente: repmultampalfrm.vue
- Ruta: /src/views/modules/multas_reglamentos/repmultampalfrm.vue

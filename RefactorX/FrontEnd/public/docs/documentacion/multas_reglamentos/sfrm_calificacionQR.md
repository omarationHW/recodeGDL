...
Este componente proporciona la interfaz para sfrm calificacion qr.
...
- Componente: sfrm_calificacionQR.vue
- Ruta: /src/views/modules/multas_reglamentos/sfrm_calificacionQR.vue

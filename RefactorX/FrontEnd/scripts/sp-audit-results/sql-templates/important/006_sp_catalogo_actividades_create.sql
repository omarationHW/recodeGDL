-- ============================================================
-- Stored Procedure: sp_catalogo_actividades_create
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_catalogo_actividades_create('valor_p_generico', 'valor_p_uso', 'valor_p_actividad', 'valor_p_concepto');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_catalogo_actividades_create' AND routine_schema = 'public';

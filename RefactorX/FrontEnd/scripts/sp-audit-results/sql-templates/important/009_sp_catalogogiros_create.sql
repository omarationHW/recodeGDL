-- ============================================================
-- Stored Procedure: sp_catalogogiros_create
-- ============================================================
...
-- Parámetros:
  ...
  -- @param p_p_ctaaplic: [Descripción del parámetro]
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_catalogogiros_create('valor_p_cod_giro', 'valor_p_descripcion', 'valor_p_cod_anun', 'valor_p_caracteristicas', 'valor_p_clasificacion', 'valor_p_tipo', 'valor_p_reglamentada', 'valor_p_ctaaplic', 'valor_p_vigente');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_catalogogiros_create' AND routine_schema = 'public';

-- ============================================================
-- Stored Procedure: sp_dependencias_update
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_dependencias_update('valor_p_id_dependencia', 'valor_p_dependencia', 'valor_p_id_depref', 'valor_p_estado');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_dependencias_update' AND routine_schema = 'public';

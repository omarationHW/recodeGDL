-- ============================================================
-- Stored Procedure: sp_dictamenes_create
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_dictamenes_create('valor_p_id_giro', 'valor_p_propietario', 'valor_p_domicilio', 'valor_p_actividad', 'valor_p_no_exterior', 'valor_p_no_interior', 'valor_p_supconst', 'valor_p_area_util', 'valor_p_num_cajones', 'valor_p_uso_suelo', 'valor_p_desc_uso', 'valor_p_zona', 'valor_p_subzona', 'valor_p_dictamen');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_dictamenes_create' AND routine_schema = 'public';

-- ============================================================
-- Stored Procedure: sp_fechaseg_create
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_fechaseg_create('valor_p_t42_doctos_id', 'valor_p_t42_centros_id', 'valor_p_usuario_seg', 'valor_p_fec_seg', 'valor_p_t42_statusseg_id', 'valor_p_observacion', 'valor_p_usuario_mov');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_fechaseg_create' AND routine_schema = 'public';

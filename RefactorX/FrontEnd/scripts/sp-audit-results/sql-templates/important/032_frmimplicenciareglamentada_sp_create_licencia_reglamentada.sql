-- ============================================================
-- Stored Procedure: frmimplicenciareglamentada_sp_create_licencia_reglamentada
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM frmimplicenciareglamentada_sp_create_licencia_reglamentada('valor_p_numero_licencia', 'valor_p_estado', 'valor_p_observaciones', 'valor_p_usuario');
--
-- ============================================================
...
-- WHERE routine_name = 'frmimplicenciareglamentada_sp_create_licencia_reglamentada' AND routine_schema = 'public';

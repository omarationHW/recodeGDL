-- ============================================================
-- Stored Procedure: gruposanunciosabcfrm_sp_anuncios_grupos_update
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM gruposanunciosabcfrm_sp_anuncios_grupos_update('valor_p_id', 'valor_p_descripcion', 'valor_p_usuario');
--
-- ============================================================
...
-- WHERE routine_name = 'gruposanunciosabcfrm_sp_anuncios_grupos_update' AND routine_schema = 'public';

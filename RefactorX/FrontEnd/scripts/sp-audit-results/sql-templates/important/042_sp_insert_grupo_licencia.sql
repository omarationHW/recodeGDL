...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_insert_grupo_licencia('valor_p_descripcion', 'valor_p_usuario');
--
-- ============================================================

CREATE OR REPLACE FUNCTION sp_insert_grupo_licencia(
...
-- WHERE routine_name = 'sp_insert_grupo_licencia' AND routine_schema = 'public';

...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_c_contribholog_create('valor_p_nombre', 'valor_p_domicilio', 'valor_p_colonia', 'valor_p_telefono', 'valor_p_rfc', 'valor_p_curp', 'valor_p_email', 'valor_p_capturista');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_c_contribholog_create' AND routine_schema = 'public';

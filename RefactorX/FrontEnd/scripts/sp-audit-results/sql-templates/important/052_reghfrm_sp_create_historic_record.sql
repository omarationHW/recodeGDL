-- ============================================================
-- Stored Procedure: reghfrm_sp_create_historic_record
-- ============================================================
...
-- Parámetros:
  ...
  -- @param p_p_fecha: [Descripción del parámetro]
...
--
-- Ejemplo de uso:
--   SELECT * FROM reghfrm_sp_create_historic_record('valor_p_tipo', 'valor_p_folio', 'valor_p_descripcion', 'valor_p_fecha', 'valor_p_estado', 'valor_p_usuario');
--
-- ============================================================
...
-- WHERE routine_name = 'reghfrm_sp_create_historic_record' AND routine_schema = 'public';

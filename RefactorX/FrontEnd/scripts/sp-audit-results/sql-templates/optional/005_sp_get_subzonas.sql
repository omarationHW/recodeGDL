...
--
-- Parámetros:
  -- @param p_p_cvezona: [Descripción del parámetro]
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_get_subzonas('valor_p_cvezona', 'valor_p_recaud');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_get_subzonas' AND routine_schema = 'public';

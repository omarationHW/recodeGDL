...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_get_convcta_by_cvecatnva_subpredio('valor_p_cvecatnva', 'valor_p_subpredio');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_get_convcta_by_cvecatnva_subpredio' AND routine_schema = 'public';

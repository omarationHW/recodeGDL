-- ============================================================
-- Stored Procedure: sp_catalogogiros_list
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_catalogogiros_list('valor_p_page', 'valor_p_page_size', 'valor_p_codigo', 'valor_p_descripcion', 'valor_p_clasificacion', 'valor_p_tipo', 'valor_p_vigente');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_catalogogiros_list' AND routine_schema = 'public';

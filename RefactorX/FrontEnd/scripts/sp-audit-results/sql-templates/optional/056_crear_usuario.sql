-- ============================================================
-- Stored Procedure: crear_usuario
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM crear_usuario('valor_p_usuario', 'valor_p_nombres', 'valor_p_clave', 'valor_p_cvedepto', 'valor_p_nivel', 'valor_p_capturo');
--
-- ============================================================
...
-- WHERE routine_name = 'crear_usuario' AND routine_schema = 'public';

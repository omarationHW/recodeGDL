...
-- Parámetros:
  ...
  -- @param p_p_filtro: [Descripción del parámetro]
--
-- Retorna:
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_buscar_colonias('valor_p_c_mnpio', 'valor_p_filtro');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_buscar_colonias' AND routine_schema = 'public';

-- ============================================================
-- Stored Procedure: sp_get_calles_search
-- ============================================================
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_get_calles_search('valor_p_busqueda', 'valor_p_limit');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_get_calles_search' AND routine_schema = 'public';

-- ============================================================
-- Stored Procedure: sp_reactivar_tramite
-- ============================================================
-- Tipo de Operación: QUERY
-- Usado en: ReactivaTramite
...
--
-- Ejemplo de uso:
--   SELECT * FROM sp_reactivar_tramite('valor_p_id_tramite', 'valor_p_motivo', 'valor_p_usuario');
--
-- ============================================================
...
-- WHERE routine_name = 'sp_reactivar_tramite' AND routine_schema = 'public';

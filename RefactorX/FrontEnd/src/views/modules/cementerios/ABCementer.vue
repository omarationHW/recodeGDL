  ...
  <div class="module-view">
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card" v-if="fosaEncontrada">
        ...
        <div class="municipal-card-body">
          <div class="municipal-tabs">
            <button
              :class="['municipal-tab', { 'active': tabActivo === 'pagos' }]"
            ...
            <button
              :class="['municipal-tab', { 'active': tabActivo === 'adeudos' }]"
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'ABC de Fosas - Cementerios'"
...
const buscarFosa = async () => {
  ...
  showLoading('Buscando fosa...', 'Por favor espere')
...
const guardarFosa = async () => {
  ...
  showLoading('Guardando fosa...', 'Por favor espere')
...
const eliminarFosa = async () => {
  showLoading('Eliminando fosa...', 'Por favor espere')

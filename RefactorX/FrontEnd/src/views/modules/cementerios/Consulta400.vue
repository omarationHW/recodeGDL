    ...
    <div class="module-view-content">
      ...
      <div v-if="resultados.length === 0 && !hasSearched" class="empty-state">
        <div class="empty-state-icon">
          <font-awesome-icon icon="search-plus" size="3x" />
        </div>
        <h4>Consulta por R.C.M en 400</h4>
        <p>Ingrese la ubicación completa (cementerio, clase, sección, línea y fosa) para buscar registros</p>
      </div>
      ...
      <div v-else-if="resultados.length === 0 && hasSearched" class="empty-state">
        ...
        <p>No se encontraron registros con la ubicación especificada</p>
      </div>

      <!-- Resultados -->
      <div class="municipal-card" v-else>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Consulta por R.C.M en 400'"

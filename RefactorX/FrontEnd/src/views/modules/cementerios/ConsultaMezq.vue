  ...
  <div class="module-view">
    <div class="module-view-header">
      <h1 class="module-view-info">
        ...
        Consulta Cementerio Mezquitán
      </h1>
      <DocumentationModal
        title="Ayuda - Cementerio Mezquitán"
    ...
    <div v-if="folios.length > 0" class="municipal-card">
      <div class="municipal-card-header">
        ...
        Folios del Cementerio Mezquitán ({{ folios.length }})
      </div>
      <div class="municipal-card-body">
...
const CEMENTERIO_CODIGO = 'MEZQUITAN'
...
const helpSections = [
  {
    ...
    content: `
      <p>Consulta y visualización de folios del Cementerio Mezquitán.</p>

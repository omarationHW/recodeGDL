  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Consulta Cementerio Mezquitán</h1>
        <p>Cementerios - Búsqueda de folios del Cementerio Mezquitán</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card" v-if="folios.length > 0">
        <div class="municipal-card-header header-with-badge">
          <h5>
            ...
            Folios del Cementerio Mezquitán
          </h5>
      ...
      <div v-if="folios.length === 0 && !hasSearched" class="empty-state">
        <div class="empty-state-icon">
          <font-awesome-icon icon="cross" size="3x" />
        </div>
        <h4>Consulta Cementerio Mezquitán</h4>
        <p>Seleccione un tipo de búsqueda e ingrese los criterios para consultar los folios del cementerio</p>
      </div>
    ...
    <DocumentationModal
      :show="showDocModal"
      :componentName="'ConsultaMezq'"
      :moduleName="'cementerios'"
      :docType="docType"
      :title="'Consulta Cementerio Mezquitán'"
...
const buscarFolios = async () => {
  ...
  try {
    /* TODO FUTURO: Queries SQL originales (Pascal ConsultaMezq.pas)
    -- Por ubicación (RCM):
    ...
    */
    ...
    if (tipoBusqueda.value === 'ubicacion') {
      ...
      response = await execute(
        'sp_consultamezq_buscar_por_ubicacion',
        'cementerio',
        [
      ...
      response = await execute(
        'sp_consultamezq_buscar_por_nombre',
        'cementerio',
        [

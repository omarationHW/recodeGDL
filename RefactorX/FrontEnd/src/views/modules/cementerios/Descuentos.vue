        ...
        <div v-if="adeudos.length > 0" class="mt-3">
          ...
          <div class="table-container">
            <table class="municipal-table">
              ...
              <tbody>
                <tr
                  v-for="adeudo in paginatedAdeudos"
                ...
                >
                  ...
                  <td>
                    <button
                      ...
                      @click.stop="seleccionarAdeudo(adeudo)"
      ...
      <div class="municipal-card-body">
        <div class="table-container">
          <table class="municipal-table">
            ...
            <tbody>
              <tr
                v-for="desc in descuentosAplicados"
                :key="desc.control_des"
              ...
              >
                ...
                <td>
                  <button
                    ...
                    @click.stop="eliminarDescuento(desc)"

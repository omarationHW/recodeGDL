  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        ...
        <p>Historial de expedientes por apremio</p>
      </div>
      <div class="button-group ms-auto">
        ...
        <button class="btn-municipal-primary" @click="reload" v-if="filters.expediente">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            <div class="empty-state-icon">
              <font-awesome-icon icon="clock-rotate-left" size="3x" />
            </div>
            <h4>Consulta Histórica</h4>
            <p>Ingrese número de expediente para buscar historial</p>
          </div>
...
const reload = async () => {
  if (!filters.value.expediente) {
    showToast('error', 'Debe ingresar número de expediente')
    return
  }
  ...
  try {
    ...
    showToast('success', `${rows.value.length} registro(s) encontrado(s)`)
  } catch (error) {
    rows.value = []
    cols.value = []

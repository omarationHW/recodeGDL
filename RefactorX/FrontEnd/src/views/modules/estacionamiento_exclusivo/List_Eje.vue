  ...
  <div class="module-view module-layout">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Listado de Ejecutores</h1>
        <p>Relación completa de ejecutores</p>
      </div>
    ...
    <div class="module-view-content">
      <!-- Tarjeta principal de ejecutores -->
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Listado de Ejecutores</h4>
            <p>Presione "Actualizar" para cargar la lista de ejecutores</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron ejecutores en el sistema</p>
          </div>

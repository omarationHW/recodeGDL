...
const reload = async () => {
  showLoading('Cargando ejecutores...', 'Consultando registros')
  currentPage.value = 1
  const t0 = performance.now()
  try {
    const response = await execute(OP_GET, BASE_DB, [])
    let arr = []

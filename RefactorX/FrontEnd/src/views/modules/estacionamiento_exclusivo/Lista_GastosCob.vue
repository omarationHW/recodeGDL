<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - Lista_GastosCob"
    >
      <h3>Lista_ Gastos Cob</h3>
...
const OP_QUERY = 'spd_12_gastoscob'
...
const reload = async () => {
  showLoading('Cargando gastos...', 'Consultando registros')
  currentPage.value = 1

  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Gastos de Cobranza</h1>
        <p>Estacionamiento Exclusivo - Relación de gastos de cobranza</p>
      </div>
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            <div class="empty-state-icon">
              <font-awesome-icon icon="receipt" size="3x" />
            </div>
            <h4>Gastos de Cobranza</h4>
            <p>Haga clic en "Actualizar" para cargar los registros</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron gastos de cobranza</p>
          </div>
...
// Métodos principales
const reload = async () => {
  showLoading('Cargando gastos de cobranza...', 'Consultando registros')

...
const OP_QUERY = 'sp_listados_get_listados'
...
const reload = async () => {
  showLoading('Cargando listados...', 'Consultando registros')
  currentPage.value = 1

<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="broom" /></div><div class="module-view-info"><h1>Listados Ade Aseo</h1><p>Listados de adeudos de aseo</p></div><div class="button-group ms-auto"><button class="btn-municipal-primary" @click="reload"><font-awesome-icon icon="sync-alt" /> Actualizar</button>
    ...
    <div class="module-view-content">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            <div class="empty-state-icon">
              <font-awesome-icon icon="broom" size="3x" />
            </div>
            <h4>Listados Adeudos Aseo</h4>
            <p>Haga clic en "Actualizar" para cargar los adeudos de aseo</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron adeudos de aseo</p>
          </div>
      ...
      <DocumentationModal
        :show="showDocModal"
        :componentName="'ListadosAdeAseoForm'"
        :moduleName="'estacionamiento_exclusivo'"
        :docType="docType"
        :title="'Listados Adeudos Aseo'"
...
const OP_QUERY = 'sp_listados_ade_aseo'
...
const reload = async () => {
  showLoading('Cargando adeudos...', 'Aseo')

<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - ListadosAdeInfraccionesForm"
    >
      <h3>Listados Ade Infracciones Form</h3>
    ...
    <TechnicalDocsModal
      :show="showTechDocs"
      :componentName="'ListadosAdeInfraccionesForm'"
...
const OP_QUERY = 'sp_listados_ade_infracciones'
...
const reload = async () => {
  showLoading('Cargando adeudos...', 'Infracciones')
  currentPage.value = 1

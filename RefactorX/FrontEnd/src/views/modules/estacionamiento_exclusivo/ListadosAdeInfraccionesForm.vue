  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Listados Ade Infracciones</h1>
        <p>Listados de adeudos de infracciones</p>
      </div>
    ...
    <div class="module-view-content">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            <div class="empty-state-icon">
              <font-awesome-icon icon="ticket" size="3x" />
            </div>
            <h4>Listados de Adeudos de Infracciones</h4>
            <p>Presione "Actualizar" para cargar los datos</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron registros de adeudos de infracciones</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Listados Adeudos Infracciones'"

  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Listados Ade Mercados</h1>
        <p>Listados de adeudos de mercados</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Listados de Adeudos de Mercados</h4>
            <p>Haga clic en "Actualizar" para cargar los datos</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron adeudos de mercados</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Listados Adeudos Mercados'"
...
const formatLabel = (k) => {
  return k.replace(/_/g, ' ').replace(/([A-Z])/g, ' $1').replace(/^./, s => s.toUpperCase()).trim()
}

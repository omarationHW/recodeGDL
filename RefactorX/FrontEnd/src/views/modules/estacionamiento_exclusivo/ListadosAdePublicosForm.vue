  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Listados Ade Públicos</h1>
        <p>Listados de adeudos de espacios públicos</p>
      </div>
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Listados de Adeudos Públicos</h4>
            <p>Haga clic en "Actualizar" para cargar los datos de adeudos de espacios públicos</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron registros de adeudos públicos</p>
          </div>
...
// Métodos principales
const reload = async () => {
  showLoading('Cargando adeudos públicos...', 'Consultando base de datos')

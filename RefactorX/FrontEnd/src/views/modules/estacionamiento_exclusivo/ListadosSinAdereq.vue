<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - ListadosSinAdereq"
    >
      <h3>Listados Sin Adereq</h3>
    ...
    <TechnicalDocsModal
      :show="showTechDocs"
      :componentName="'ListadosSinAdereq'"
...
const OP_QUERY = 'sp_listados_sin_adereq'
...
const reload = async () => {
  showLoading('Cargando registros...', 'Sin adeudos requeridos')
  currentPage.value = 1

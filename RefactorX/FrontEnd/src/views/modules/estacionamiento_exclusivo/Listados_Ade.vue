...
const OP_QUERY = 'apremiossvn_listados_ade'
...
const reload = async () => {
  showLoading('Cargando adeudos...', 'Consultando listado')
  currentPage.value = 1

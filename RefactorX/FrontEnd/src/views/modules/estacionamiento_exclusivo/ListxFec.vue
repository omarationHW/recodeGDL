  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Listados por Fecha</h1>
        <p>Consulta de registros por rango de fechas</p>
      </div>
      <div class="button-group ms-auto">
        ...
        <button class="btn-municipal-primary" @click="reload" v-if="filters.desde && filters.hasta">
        ...
        <div v-show="showFilters" class="municipal-card-body">
          ...
          <div class="button-group">
            <button
              ...
              @click="reload"
              :disabled="!filters.desde || !filters.hasta"
            >
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Listados por Fecha</h4>
            <p>Seleccione un rango de fechas para buscar registros</p>
          </div>

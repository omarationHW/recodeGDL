  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        ...
        <p>Estacionamiento Exclusivo - Modificación de registro individual</p>
      </div>
          ...
          <div class="form-row">
            <div class="form-group full-width">
              ...
              <textarea
                ...
                rows="10"
                v-model="jsonPayload"
                placeholder='{"expediente":"123","campo":"valor"}'
              ></textarea>
            </div>
          </div>
...
const guardar = async () => {
  ...
  try {
    ...
    const mensaje = arr?.result || arr?.mensaje || 'Registro modificado exitosamente'

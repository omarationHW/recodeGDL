<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="screwdriver-wrench" /></div><div class="module-view-info"><h1>Modificar Bien</h1><p>Modificación de bienes embargables</p></div>
    ...
    <DocumentationModal
      ...
      title="Ayuda - Modificar_bien"
    >
      <h3>Modificar_bien</h3>

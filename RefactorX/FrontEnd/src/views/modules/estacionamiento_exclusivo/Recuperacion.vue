  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Recuperación</h1>
        <p>Estacionamiento Exclusivo - Listado de Recuperaciones</p>
      </div>
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            <div class="empty-state-icon">
              <font-awesome-icon icon="rotate" size="3x" />
            </div>
            <h4>Recuperaciones</h4>
            <p>Haga clic en "Actualizar" para cargar los registros de recuperación</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron registros de recuperación</p>
          </div>

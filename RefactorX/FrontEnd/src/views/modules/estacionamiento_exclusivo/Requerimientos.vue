  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        ...
        <p>Estacionamiento Exclusivo - Listado de requerimientos activos</p>
      </div>
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <p>Haga clic en "Actualizar" para cargar los requerimientos activos</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron requerimientos con los criterios especificados</p>
          </div>
...
const reload = async () => {
  ...
  try {
    ...
    showToast('success', `Se cargaron ${rows.value.length} registros`)
  } catch (error) {
    rows.value = []
    cols.value = []

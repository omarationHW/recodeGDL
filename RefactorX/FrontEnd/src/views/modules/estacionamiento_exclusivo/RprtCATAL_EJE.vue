<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RprtCATAL_EJE"
    >
      <h3>Rprt C A T A L_ E J E</h3>
...
const limpiar = () => { p_id_rec.value=''; p_vigencia.value=''; rows.value=[]; cols.value=[]; searched.value=false; currentPage.value=1 }

  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte Estatus por Folio</h1>
        <p>Estacionamiento Exclusivo - Estatus de apremios por folio</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Reporte Estatus por Folio</h4>
            <p>Use los filtros para buscar registros de apremios por folio</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte Estatus por Folio'"
...
const buscar = async () => {
  ...
  try {
    ...
    showToast('success', `${rows.value.length} folio(s) encontrados`)
  } catch (e) {
    rows.value = []
    cols.value = []
    handleApiError(e)

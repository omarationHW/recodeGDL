<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RprtList_Eje"
    >
      <h3>Rprt List_ Eje</h3>
...
const buscar = async () => {
  ...
  try {
    ...
    showToast('success', `${rows.value.length} ejecutor(es) en ${txt}`)
  } catch (e) {
    rows.value = []
    cols.value = []
    handleApiError(e)
...
const limpiar = () => { varios.value=''; vvig.value=''; vrec.value=''; vopc.value=''; vfec1.value=''; vfec2.value=''; vrecaudadora.value=''; vfecP1.value=''; vfecP2.value=''; vnombre.value=''; rows.value=[]; cols.value=[]; searched.value=false; currentPage.value=1 }

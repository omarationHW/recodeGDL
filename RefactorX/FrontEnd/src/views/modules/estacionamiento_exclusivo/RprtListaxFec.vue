<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RprtListaxFec"
    >
      <h3>Rprt Listax Fec</h3>
...
const limpiar = () => { vrec.value=''; vmod.value=''; vcve.value=''; vfec1.value=''; vfec2.value=''; vvig.value=''; veje.value=''; rows.value=[]; cols.value=[]; searched.value=false; currentPage.value=1 }

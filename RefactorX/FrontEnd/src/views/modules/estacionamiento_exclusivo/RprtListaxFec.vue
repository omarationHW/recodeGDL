<template>
  <div class="module-view module-layout"><div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="calendar" /></div><div class="module-view-info"><h1>Reporte por Fecha</h1></div></div>
...
<script setup>
import { ref } from 'vue'; import { useApi } from '@/composables/useApi'; const { execute } = useApi(); const BASE_DB='INFORMIX'; const OP='APREMIOSSVN_RPRTLISTAXFEC'; const desde=ref(''); const hasta=ref(''); const rows=ref([]); const cols=ref([]);

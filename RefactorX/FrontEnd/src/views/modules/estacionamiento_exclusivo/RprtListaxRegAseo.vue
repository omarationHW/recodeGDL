  ...
  <div class="module-view module-layout">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte por Registro Aseo</h1>
        <p>Listado de apremios por registro de aseo</p>
      </div>
    ...
    <div class="module-view-content">
        ...
        <div class="municipal-card-body">
          <div class="form-row">
            <div class="form-group">
              <label class="municipal-form-label">ID Recaudadora</label>
              <input
            ...
            <div class="form-group">
              ...
              <input
                ...
                placeholder="Clave Practicado (o 'todas')"
              />
            </div>
            <div class="form-group">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Reporte por Registro Aseo</h4>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte por Registro Aseo'"
...
const limpiar = () => {
  p_id_rec.value = ''
  p_tipo_aseo.value = ''
  p_clave_practicado.value = 'todas'
  p_vigencia.value = 'todas'
  rows.value = []
  cols.value = []

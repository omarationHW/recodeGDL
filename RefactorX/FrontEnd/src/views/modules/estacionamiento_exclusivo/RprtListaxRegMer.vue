  ...
  <div class="module-view module-layout">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte por Registro Mercados</h1>
        <p>Listado de apremios por mercados</p>
      </div>
    ...
    <div class="module-view-content">
      <div v-if="showFilters" class="municipal-card">
        ...
        <div class="municipal-card-body">
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="municipal-form-label">Número Mercado</label>
              <input
                class="municipal-form-control"
                type="number"
                v-model="p_num_mercado"
                placeholder="Número Mercado"
                @keyup.enter="buscar"
              />
            </div>
            <div class="form-group">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Reporte por Registro Mercados</h4>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte por Registro Mercados'"

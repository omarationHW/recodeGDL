  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte Facturación Mercados</h1>
        <p>Estacionamiento Exclusivo - Reporte de facturación para mercados</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <p>Haga clic en "Actualizar" para cargar los datos de facturación</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte Facturación Mercados'"

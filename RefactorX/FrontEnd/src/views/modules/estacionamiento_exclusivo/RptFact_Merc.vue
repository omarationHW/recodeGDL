<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptFact_Merc"
    >
      <h3>Reporte  Fact_ Merc</h3>
...
const OP_QUERY = 'rptfact_merc_get_report'
...
const reload = async () => {
  showLoading('Cargando facturación...', 'Reporte de mercados')
  currentPage.value = 1

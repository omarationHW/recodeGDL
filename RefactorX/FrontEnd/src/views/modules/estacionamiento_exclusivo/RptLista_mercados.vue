<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptLista_mercados"
    >
      <h3>Reporte  Lista_mercados</h3>
    ...
    <TechnicalDocsModal
      :show="showTechDocs"
      :componentName="'RptLista_mercados'"
...
const OP_QUERY = 'rpt_lista_mercados'
...
const reload = async () => {
  showLoading('Cargando lista...', 'Mercados')
  currentPage.value = 1
  ...
  try {
    ...
    showToast('success', `${rows.value.length} mercado(s) en ${txt}`)
  } catch (e) {
    rows.value = []
    cols.value = []
    handleApiError(e)

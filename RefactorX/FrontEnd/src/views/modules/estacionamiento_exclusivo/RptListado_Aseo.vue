<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="broom" /></div><div class="module-view-info"><h1>Reporte Listado Aseo</h1><p>Listado completo de aseo público</p></div><div class="button-group ms-auto"><button class="btn-municipal-primary" @click="reload"><font-awesome-icon icon="sync-alt" /> Actualizar</button></div></div>
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptListado_Aseo"
    >
      <h3>Reporte  Listado_ Aseo</h3>
...
const OP_QUERY = 'rpt_listado_aseo'
...
const reload = async () => {
  showLoading('Cargando listado...', 'Aseo público')
  currentPage.value = 1

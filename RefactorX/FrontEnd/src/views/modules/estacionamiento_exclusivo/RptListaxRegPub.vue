<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptListaxRegPub"
    >
      <h3>Reporte  Listax Reg Pub</h3>
...
const OP_QUERY = 'rpt_listaxregpub_get_report'
...
const reload = async () => {
  showLoading('Cargando listado...', 'Espacios públicos')
  currentPage.value = 1

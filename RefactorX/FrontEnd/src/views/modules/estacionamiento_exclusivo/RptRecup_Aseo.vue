<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptRecup_Aseo"
    >
      <h3>Reporte  Recup_ Aseo</h3>
...
const OP_QUERY = 'rptrecup_aseo_report'
...
const reload = async () => {
  showLoading('Cargando recuperación...', 'Aseo público')
  currentPage.value = 1

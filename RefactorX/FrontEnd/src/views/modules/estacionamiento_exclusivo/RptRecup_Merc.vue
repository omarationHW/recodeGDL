  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte Recuperación Mercados</h1>
        <p>Estacionamiento Exclusivo - Reporte de recuperación de mercados</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Reporte de Recuperación Mercados</h4>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte Recuperación Mercados'"
...
const reload = async () => {
  showLoading('Cargando reporte de recuperación...', 'Consultando mercados')

<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptRecup_Merc"
    >
      <h3>Reporte  Recup_ Merc</h3>
...
const OP_QUERY = 'rptrecup_merc_report'
...
const reload = async () => {
  showLoading('Cargando recuperación...', 'Mercados')
  currentPage.value = 1

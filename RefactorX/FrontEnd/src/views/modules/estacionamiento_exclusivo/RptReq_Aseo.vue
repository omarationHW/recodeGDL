  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte Requerimientos Aseo</h1>
        <p>Reporte de requerimientos de aseo</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Reporte de Requerimientos de Aseo</h4>
            <p>Haga clic en "Actualizar" para cargar los requerimientos de aseo</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron requerimientos de aseo</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte Requerimientos Aseo'"
...
// Métodos principales
const reload = async () => {
  showLoading('Cargando requerimientos de aseo...', 'Consultando base de datos')

<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptReq_Aseo"
    >
      <h3>Reporte  Req_ Aseo</h3>
...
const OP_QUERY = 'rptreq_aseo_report'
...
const reload = async () => {
  showLoading('Cargando requerimientos...', 'Aseo')
  currentPage.value = 1

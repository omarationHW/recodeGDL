<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptReq_Merc"
    >
      <h3>Reporte  Req_ Merc</h3>
...
const OP_QUERY = 'rptreq_merc_reporte'
...
const reload = async () => {
  showLoading('Cargando requerimientos...', 'Mercados')
  currentPage.value = 1

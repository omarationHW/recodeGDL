  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte Prueba Requerimientos Aseo</h1>
        <p>Estacionamiento Exclusivo - Reporte de prueba de requerimientos</p>
      </div>
    ...
    <div class="module-view-content">
      ...
      <div class="municipal-card">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            ...
            <h4>Reporte de Prueba</h4>
            <p>Haga clic en "Actualizar" para cargar el reporte de requerimientos de aseo</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte Prueba Requerimientos Aseo'"

<template>
  <div class="module-view module-layout">
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptReq_Pba_Aseo"
    >
      <h3>Reporte  Req_ Pba_ Aseo</h3>
...
const OP_QUERY = 'rptreq_pba_aseo_get_report'
...
const reload = async () => {
  showLoading('Cargando prueba...', 'Requerimientos aseo')
  currentPage.value = 1

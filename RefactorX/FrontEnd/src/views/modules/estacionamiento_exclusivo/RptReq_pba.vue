<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="flask" /></div><div class="module-view-info"><h1>Reporte Prueba Requerimientos</h1><p>Reporte de prueba general de requerimientos</p></div><div class="button-group ms-auto"><button class="btn-municipal-primary" @click="reload"><font-awesome-icon icon="sync-alt" /> Actualizar</button></div></div>
    ...
    <DocumentationModal
      ...
      title="Ayuda - RptReq_pba"
    >
      <h3>Reporte  Req_pba</h3>
...
const OP_QUERY = 'rptreq_pba_get_report_data'
...
const reload = async () => {
  showLoading('Cargando prueba...', 'Requerimientos')
  currentPage.value = 1

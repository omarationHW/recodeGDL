  ...
  <div class="module-view">
    ...
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Reporte Prueba Requerimientos</h1>
        <p>Reporte de prueba general de requerimientos</p>
      </div>
    ...
    <div class="module-view-content">
        ...
        <div class="municipal-card-body table-container">
          ...
          <div v-if="rows.length === 0 && !hasSearched" class="empty-state">
            <div class="empty-state-icon">
              <font-awesome-icon icon="flask" size="3x" />
            </div>
            <h4>Reporte Prueba Requerimientos</h4>
            <p>Haga clic en "Actualizar" para cargar los datos del reporte</p>
          </div>
          ...
          <div v-else-if="rows.length === 0 && hasSearched" class="empty-state">
            ...
            <p>No se encontraron registros en el reporte</p>
          </div>
      ...
      <DocumentationModal
        ...
        :docType="docType"
        :title="'Reporte Prueba Requerimientos'"
...
const reload = async () => {
  showLoading('Cargando reporte...', 'Consultando requerimientos')
  ...
  try {
    ...
    showToast('success', `${rows.value.length} registro(s) cargado(s)`)
  } catch (e) {
    rows.value = []
    cols.value = []
    handleApiError(e)

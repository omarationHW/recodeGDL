  ...
  <div class="acceso-page">
    <div class="acceso-form-container">
      <div class="acceso-header">
        <h2>Estacionamiento Exclusivo</h2>
...
export default {
  name: 'AccesoEstacionamientoExclusivo',
  data() {
    return {
      form: {
        usuario: '',
            ...
            sessionService.setSession(
              {
                ...
                sistema: 'estacionamiento_exclusivo'
              },
              this.form.ejercicio
            );
            console.log('✅ Login exitoso (Estacionamiento Exclusivo):', sessionService.getSessionInfo());
            this.$router.push('/estacionamiento-exclusivo');
          } else {
            this.intentos++;
            if (this.intentos >= 3) {
...
<style scoped>
/* =================================================================================
   LOGIN ESTACIONAMIENTO EXCLUSIVO - TEMA MUNICIPAL GUADALAJARA

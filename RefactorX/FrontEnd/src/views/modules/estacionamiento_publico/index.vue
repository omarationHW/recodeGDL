    ...
    <div class="dashboard-content">
      <div class="dashboard-header">
        ...
        <div class="header-center">
          <h1>Estacionamiento Publico</h1>
          <p>Gestion de parquimetros y estacionometros</p>
        </div>
      ...
      <div class="systems-section">
        <div class="section-header">
          <div class="section-icon"><font-awesome-icon icon="car" /></div>
...
const sections = [
  { icon: 'ticket-alt', title: 'Folios', desc: 'Alta y consulta de folios', links: [{ to: '/estacionamiento-publico/folios-alta', label: 'Alta' }, { to: '/estacionamiento-publico/consulta', label: 'Consulta' }] },
      { icon: 'credit-card', title: 'Pagos', desc: 'Registro de pagos', links: [{ to: '/estacionamiento-publico/pagos', label: 'Registro' }, { to: '/estacionamiento-publico/edocta', label: 'Estado Cuenta' }] },
      { icon: 'parking', title: 'Parquimetros', desc: 'Gestion de parquimetros', links: [{ to: '/estacionamiento-publico/metrometers', label: 'Gestion' }, { to: '/estacionamiento-publico/inspectores', label: 'Inspectores' }] },
      { icon: 'user-cog', title: 'Administracion', desc: 'Configuracion general', links: [{ to: '/estacionamiento-publico/admin', label: 'General' }, { to: '/estacionamiento-publico/nuevo', label: 'Nuevo' }] },
      { icon: 'chart-bar', title: 'Reportes', desc: 'Estadisticas del sistema', links: [{ to: '/estacionamiento-publico/reportes', label: 'General' }, { to: '/estacionamiento-publico/estadisticas', label: 'Estadisticas' }] },
      { icon: 'cogs', title: 'Configuracion', desc: 'Seguridad y accesos', links: [{ to: '/estacionamiento-publico/accesos', label: 'Acceso' }, { to: '/estacionamiento-publico/passwords', label: 'Seguridad' }] }
]
</script>

    ...
    <div class="module-view-content">
      <div class="container-fluid mt-4">
          <div class="alert alert-info" role="alert">
            <h4 class="alert-heading">🏪 Cons Captura Merc</h4>
            <p>Este componente está en desarrollo y será implementado próximamente.</p>
            <hr>
            <p class="mb-0">
              <small><strong>Módulo:</strong> Mercados | <strong>Componente:</strong> ConsCapturaMerc</small>
            </p>
          </div>
          
          <div class="municipal-card">
            <div class="municipal-card">
              <h5 class="mb-0">Cons Captura Merc</h5>
            </div>
            <div class="municipal-card">
              <p class="text-muted">
...
export default {
  ...
  mounted() {
    console.log('Componente ConsCapturaMerc montado (placeholder)');
  }
}
</script>

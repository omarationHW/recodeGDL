<template>
  ...
  <DocumentationModal :show="showAyuda" :component-name="'ConsPagos'" :module-name="'mercados'" :doc-type="'ayuda'" :title="'Mercados - ConsPagos'" @close="showAyuda = false" />
  <DocumentationModal :show="showDocumentacion" :component-name="'ConsPagos'" :module-name="'mercados'" :doc-type="'documentacion'" :title="'Mercados - ConsPagos'" @close="showDocumentacion = false" />
</template>

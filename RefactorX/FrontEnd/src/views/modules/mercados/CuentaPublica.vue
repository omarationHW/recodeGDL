      ...
      <div class="cuenta-publica-page">
          ...
          <div class="form-row mb-3">
            <div class="col-md-2">
              ...
              <select v-model="form.oficina" class="municipal-form-control">
                <option v-for="rec in recaudadoras" :key="rec.id_rec" :value="rec.id_rec">{{ rec.id_rec }} - {{ rec.recaudadora }}</option>
              </select>
            </div>
            <div class="col-md-2">
              <label>Año</label>
              <input type="number" v-model.number="form.axo" class="municipal-form-control" min="1992" max="2999" />
            </div>
            <div class="col-md-2">
              <label>Mes</label>
              <input type="number" v-model.number="form.periodo" class="municipal-form-control" min="1" max="12" />
            </div>
            <div class="col-md-2 align-self-end">
              <button class="btn-municipal-primary" @click="consultar">Consultar</button>
            </div>
            <div class="col-md-2 align-self-end">
              <button class="btn-municipal-secondary" @click="imprimir" :disabled="!estadAdeudo.length">Imprimir</button>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">

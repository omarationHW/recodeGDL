<template>
  ...
  <DocumentationModal :show="showAyuda" :component-name="'RptEmisionLaser'" :module-name="'mercados'" :doc-type="'ayuda'" :title="'Mercados - RptEmisionLaser'" @close="showAyuda = false" />
  <DocumentationModal :show="showDocumentacion" :component-name="'RptEmisionLaser'" :module-name="'mercados'" :doc-type="'documentacion'" :title="'Mercados - RptEmisionLaser'" @close="showDocumentacion = false" />
</template>

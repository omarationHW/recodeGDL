<template>
  ...
  <DocumentationModal :show="showAyuda" :component-name="'RptFacturaEmision'" :module-name="'mercados'" :doc-type="'ayuda'" :title="'Mercados - RptFacturaEmision'" @close="showAyuda = false" />
  <DocumentationModal :show="showDocumentacion" :component-name="'RptFacturaEmision'" :module-name="'mercados'" :doc-type="'documentacion'" :title="'Mercados - RptFacturaEmision'" @close="showDocumentacion = false" />
</template>

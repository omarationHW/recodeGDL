<template>
  ...
  <DocumentationModal :show="showAyuda" :component-name="'RptIngresosEnergia'" :module-name="'mercados'" :doc-type="'ayuda'" :title="'Mercados - RptIngresosEnergia'" @close="showAyuda = false" />
  <DocumentationModal :show="showDocumentacion" :component-name="'RptIngresosEnergia'" :module-name="'mercados'" :doc-type="'documentacion'" :title="'Mercados - RptIngresosEnergia'" @close="showDocumentacion = false" />
</template>

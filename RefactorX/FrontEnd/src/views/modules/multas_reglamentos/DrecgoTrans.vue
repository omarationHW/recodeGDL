<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="truck" /></div><div class="module-view-info"><h1>Derechos de Tránsito</h1><p>Consulta y control</p></div></div>
...
const OP_LIST='RECAUDADORA_DRECGO_TRANS' // TODO confirmar

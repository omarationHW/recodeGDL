  ...
  <div class="module-view module-layout">
    <div class="module-view-header">
      ...
      <div class="module-view-info">
        <h1>Ejecutores</h1>
        <p>Catálogo de ejecutores del municipio</p>
      </div>
    ...
    <div class="module-view-content">
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input
                ...
                v-model="filters.q"
                @keyup.enter="reload"
                placeholder="Buscar por nombre, ID u otro campo"
              />
            </div>
          </div>
      ...
      <div class="municipal-card">
        <div class="municipal-card-header">
          <h5><font-awesome-icon icon="list" /> Ejecutores ({{ rows.length }} registros)</h5>

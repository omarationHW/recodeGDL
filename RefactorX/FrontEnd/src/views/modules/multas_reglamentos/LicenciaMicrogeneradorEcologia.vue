<template>
  <div class="module-view module-layout"><div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="leaf" /></div><div class="module-view-info"><h1>Licencia Microgenerador Ecología</h1></div></div>
...
const { loading, execute } = useApi(); const BASE_DB = 'multas_reglamentos'; const OP='RECAUDADORA_LICENCIAMICROGENERADORECOLOGIA'; const filters=ref({ rfc:'' }); const rows=ref([]); const cols=ref([])

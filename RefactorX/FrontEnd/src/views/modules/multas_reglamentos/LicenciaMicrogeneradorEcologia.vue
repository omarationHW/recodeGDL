...
const { loading, execute } = useApi(); const BASE_DB='INFORMIX'; const OP='RECAUDADORA_LICENCIAMICROGENERADORECOLOGIA'; const filters=ref({ rfc:'' }); const rows=ref([]); const cols=ref([])

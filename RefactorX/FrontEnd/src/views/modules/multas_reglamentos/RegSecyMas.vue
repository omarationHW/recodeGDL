<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="clipboard-list" /></div><div class="module-view-info"><h1>Registro, Secretaría y Más</h1><p>Procesos administrativos</p></div></div>
...
const OP_LIST = 'RECAUDADORA_REGSECYMAS' // TODO confirmar

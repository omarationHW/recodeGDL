<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="badge-percent" /></div><div class="module-view-info"><h1>Requerimiento Promoción</h1><p>Consulta y gestión</p></div></div>
...
const OP_LIST = 'RECAUDADORA_REQ_PROMOCION' // TODO confirmar

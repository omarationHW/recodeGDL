<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="folder-open" /></div><div class="module-view-info"><h1>Requerimientos DM</h1><p>Consulta de requerimientos</p></div></div>
...
const OP_LIST = 'RECAUDADORA_REQUERIMIENTOS_DM' // TODO confirmar

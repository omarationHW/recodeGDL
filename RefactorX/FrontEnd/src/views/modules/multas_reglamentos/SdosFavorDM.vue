<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="piggy-bank" /></div><div class="module-view-info"><h1>Saldos a Favor DM</h1><p>Consulta de saldos</p></div></div>
...
const OP_LIST='RECAUDADORA_SDOSFAVOR_DM' // TODO confirmar

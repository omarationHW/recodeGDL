<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="folder" /></div><div class="module-view-info"><h1>Control de Expedientes (Saldos Favor)</h1><p>Consulta y control</p></div></div>

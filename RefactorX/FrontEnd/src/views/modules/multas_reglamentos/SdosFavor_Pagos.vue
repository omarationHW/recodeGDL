<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="receipt" /></div><div class="module-view-info"><h1>Pagos de Saldos a Favor</h1><p>Consulta de pagos</p></div></div>
    <div class="module-view-content">
      ...
      <div class="municipal-card"><div class="municipal-card-header"><h5>Pagos</h5><div v-if="loading" class="spinner-border"></div></div>
...
const OP_LIST='RECAUDADORA_SDOSFAVOR_PAGOS' // TODO confirmar

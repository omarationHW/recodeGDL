<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="unlink" /></div><div class="module-view-info"><h1>Sin Ligar</h1><p>Registros no vinculados</p></div></div>
...
const OP_LIST='RECAUDADORA_SINLIGARFRM' // TODO confirmar

<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="hand-holding-dollar" /></div><div class="module-view-info"><h1>Solicitudes Saldos a Favor</h1><p>Consulta y gestión</p></div></div>
    <div class="module-view-content">
      ...
      <div class="municipal-card"><div class="municipal-card-header"><h5>Solicitudes</h5><div v-if="loading" class="spinner-border"></div></div>
...
const OP_LIST='RECAUDADORA_SOL_SDOS_FAVOR' // TODO confirmar

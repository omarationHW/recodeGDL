<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="lock" /></div><div class="module-view-info"><h1>Bloqueo Cuentas Requeridas</h1><p>Gestión de bloqueos</p></div></div>
    <div class="module-view-content">
      ...
      <div class="municipal-card"><div class="municipal-card-header"><h5>Bloqueos</h5><div v-if="loading" class="spinner-border"></div></div>

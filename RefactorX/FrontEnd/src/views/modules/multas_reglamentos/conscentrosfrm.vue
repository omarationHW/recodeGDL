<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="building-columns" /></div><div class="module-view-info"><h1>Consulta de Centros</h1><p>conscentrosfrm.vue</p></div></div>
    <div class="module-view-content">
      ...
      <div class="municipal-card"><div class="municipal-card-header"><h5>Centros</h5><div v-if="loading" class="spinner-border"></div></div>

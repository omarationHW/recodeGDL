<template>
  <div class="module-view module-layout">
    <div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="percent" /></div><div class="module-view-info"><h1>Consulta de Descuentos</h1><p>consdesc.vue</p></div></div>
    <div class="module-view-content">
      ...
      <div class="municipal-card"><div class="municipal-card-header"><h5>Descuentos</h5><div v-if="loading" class="spinner-border"></div></div>
...
const OP_LIST='RECAUDADORA_CONSDESC' // TODO confirmar

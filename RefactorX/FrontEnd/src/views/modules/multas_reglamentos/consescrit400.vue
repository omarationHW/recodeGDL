<template>
  <div class="module-view module-layout"><div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="file-signature" /></div><div class="module-view-info"><h1>Consulta Escrituras 400</h1></div></div>
...
const { loading, execute } = useApi(); const BASE_DB = 'multas_reglamentos'; const OP='RECAUDADORA_CONSESCRIT400'; const filters=ref({ cuenta:'' }); const rows=ref([]); const cols=ref([])

<template>
  <div class="module-view module-layout"><div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="percent" /></div><div class="module-view-info"><h1>Desc. Multa Municipal</h1></div></div>
...
const { loading, execute } = useApi(); const BASE_DB = 'multas_reglamentos'; const OP='RECAUDADORA_DESCMULTAMPALFRM'; const filters=ref({ cuenta:'' }); const rows=ref([]); const cols=ref([])

...
const { loading, execute } = useApi(); const BASE_DB='INFORMIX'; const OP='RECAUDADORA_DRECGOOTRASOBLIGACIONES'; const filters=ref({ cuenta:'' }); const rows=ref([]); const cols=ref([])

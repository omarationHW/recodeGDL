<template>
  <div class="module-view module-layout"><div class="module-view-header"><div class="module-view-icon"><font-awesome-icon icon="truck-ramp-box" /></div><div class="module-view-info"><h1>Entrega</h1><p>Registro de entrega</p></div></div>

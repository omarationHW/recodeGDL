<template>
  <div class="module-view module-layout">
    <div class="module-view-header">
      ...
      <div class="module-view-info"><h1>Prescripción Sec 01</h1></div>
    </div>
      ...
      <div class="municipal-card">
        <div class="municipal-card-body">
          ...
          <div class="button-group">
            <button class="btn-municipal-primary" :disabled="loading" @click="reload">Buscar</button>
          </div>
        </div>
      </div>
      <div class="municipal-card">

    ...
    <div class="dashboard-content">
      <div class="dashboard-header">
        ...
        <div class="header-center">
          ...
          <p>Gestion de obligaciones fiscales diversas</p>
        </div>
      ...
      <div class="systems-section">
        <div class="section-header">
          <div class="section-icon"><font-awesome-icon icon="file-alt" /></div>
...
const sections = [
  { icon: 'truck-pickup', title: 'Gruas', desc: 'Alta y consulta de gruas', links: [{ to: '/otras-obligaciones/gnuevos', label: 'Alta' }, { to: '/otras-obligaciones/gconsulta', label: 'Consulta' }] },
      { icon: 'trailer', title: 'Remolques', desc: 'Alta y consulta de remolques', links: [{ to: '/otras-obligaciones/rnuevos', label: 'Alta' }, { to: '/otras-obligaciones/rconsulta', label: 'Consulta' }] },
      { icon: 'file-invoice-dollar', title: 'Adeudos Gruas', desc: 'Control de adeudos', links: [{ to: '/otras-obligaciones/gadeudos', label: 'Consulta' }, { to: '/otras-obligaciones/gadeudos-gral', label: 'General' }] },
      { icon: 'money-bill', title: 'Adeudos Remolques', desc: 'Control de adeudos', links: [{ to: '/otras-obligaciones/radeudos', label: 'Consulta' }, { to: '/otras-obligaciones/radeudos-opc-mult', label: 'Multiple' }] },
      { icon: 'chart-bar', title: 'Reportes', desc: 'Reportes del padron', links: [{ to: '/otras-obligaciones/grep-padron', label: 'Gruas' }, { to: '/otras-obligaciones/rrep-padron', label: 'Remolques' }] },
      { icon: 'cogs', title: 'Catalogos', desc: 'Rubros y etiquetas', links: [{ to: '/otras-obligaciones/rubros', label: 'Rubros' }, { to: '/otras-obligaciones/etiquetas', label: 'Etiquetas' }] }
]
</script>

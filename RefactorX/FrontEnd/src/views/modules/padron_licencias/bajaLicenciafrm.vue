<template>
  <div class="module-view">
    ...
    <div class="module-view-content">
      ...
      <div v-if="!licenciaData && !hasSearched" class="empty-state">
        <div class="empty-state-icon">
          <font-awesome-icon icon="ban" size="3x" />
        </div>
        <h4>Baja de Licencias</h4>
        <p>Ingrese el número de licencia en el panel de búsqueda para dar de baja una licencia comercial</p>
      </div>

      <!-- Empty State - Sin resultados -->
      <div v-else-if="!licenciaData && hasSearched" class="empty-state">
        <div class="empty-state-icon">
          <font-awesome-icon icon="inbox" size="3x" />
        </div>
        <h4>Sin resultados</h4>
        <p>No se encontró la licencia especificada</p>
      </div>
...
const ejecutarBaja = async () => {
  ...
  showLoading('Procesando baja de licencia...')

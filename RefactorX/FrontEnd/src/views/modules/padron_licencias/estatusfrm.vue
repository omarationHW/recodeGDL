  ...
  <div class="module-view">
    ...
    <div class="module-view-header" style="position: relative;">
      ...
      <div class="module-view-info">
        ...
        <p>Padrón de Licencias - Cambiar Estado de Revisiones de Trámites</p></div>
      <button
        type="button"
        class="btn-help-icon"
    ...
    <div class="municipal-card" v-if="revisionInfo">
      <div class="municipal-card-header">
        <h5>
          ...
          Historial de Cambios de Estatus
          <span class="badge-info" v-if="historialEstatus.length > 0">{{ historialEstatus.length }} registros</span>
        </h5>
        <button
          class="btn-municipal-secondary btn-sm"
          @click="loadHistorialEstatus"
          :disabled="loading"
        >
...
const searchTramite = async () => {
  ...
  setLoading(true, 'Buscando información de la revisión...')
  ...
  const result = await Swal.fire({
    ...
    html: `
      <div style="text-align: left; padding: 0 20px;">
        <p style="margin-bottom: 10px;">Se cambiará el estatus de la revisión:</p>
        <ul style="list-style: none; padding: 0;">
          <li style="margin: 5px 0;"><strong>Trámite:</strong> ${filters.value.tramite}</li>
          <li style="margin: 5px 0;"><strong>Estatus Actual:</strong> ${revisionInfo.value.estatus || 'Pendiente'}</li>
          <li style="margin: 5px 0;"><strong>Nuevo Estatus:</strong> <span style="color: #ea8215;">${statusForm.value.estatus}</span></li>
          <li style="margin: 5px 0;"><strong>Observaciones:</strong> ${statusForm.value.observaciones}</li>
        </ul>
      </div>
    `,
...
const changeStatus = async () => {
  setLoading(true, 'Cambiando estatus de revisión...')

// Script para crear el stored procedure sp_empleados_list
const { Client } = require('pg');

async function createEmpleadosListSP() {
  ...
  try {
    ...
    // Crear el stored procedure sp_empleados_list
    console.log('🔧 Creando sp_empleados_list...');
    const createSP = `
      ...
      BEGIN
        ...
        SELECT
          ...
          CAST(u.cvedepto AS TEXT) as departamento,
          CASE
    ...
    console.log('✅ sp_empleados_list creado exitosamente');

    // Probar el stored procedure
    console.log('🧪 Probando sp_empleados_list...');

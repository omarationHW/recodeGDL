...
export default {
  ...
  setup() {
    ...
    // Lista de archivos reales disponibles en el módulo convenios
    const availableFiles = [
      "Acceso", "ActualizaCont", "ActualizaDevolucion", "ActualizaPlazo", "AdeudosContratos",
      "AfectaPagADMIN", "AltaConvDiversos", "AltaConvenios", "AltaPagosPredios", "AmpliacionesMtto",
      "Busca", "BuscaRegistroModulo", "CalculoRecargos", "Calles", "CallesMntto", "CancelacionMasiva",
      "CargaPagDiversos", "Colonias", "ColoniasMntto", "ConsContratos", "ConsDesgloce",
      "ConsIndividual", "ConsPagContratos", "ConsPagosDiversos", "ConsPagosPredios", "ConsPredios",
      "ConsultaIngreso", "ConsultaNuevoPlazo", "CorregirCaptura", "DesgloceAdeudosDiv",
      "DesgloceParcialidades", "DetalleAdeudo", "DetallePagos", "DetallePagosConvPred",
      "DetallePagosDiversos", "deudagrupo", "DevolucionMtto", "EdoCuenta", "ElaboraConvenios",
      "ElaboroConvenio", "ElaboroMntto", "EstadisticasContratos", "Firmas", "FirmasMntto",
      "ImprimeOficio", "IndividualDiversos", "IndividualPredios", "Intereses", "InteresesMtto",
      "ListadoConvDiversos", "MantPagosContratos", "Mensajes", "Menu", "ModifConvDiversos",
      "ModuloBD", "PadronAdeudos", "PadronConvEjec", "PadronConvenios", "ParcialidadesVencidas",
      "PasoContratos", "PasoConvDiversos", "PasoPagos", "Predial"
    ]
    ...
    const loadComponent = async () => {
      ...
      try {
        ...
        if (bestMatch) {
          ...
          try {
            const componentModule = await import(`../../components/modules/convenios/${bestMatch}.vue`)
              ...
              template: `
                <div class="container-fluid mt-4">
                  <div class="alert alert-warning" role="alert">
                    ...
                    <hr>
                    <p class="mb-0">
                      <small>Módulo: Convenios | Componente: ${componentName.value}</small>
                    </p>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between">
                        ...
                        <small class="text-muted">Módulo: Convenios</small>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          console.error('Archivos disponibles:', availableFiles.slice(0, 10))
          throw new Error(`No se pudo encontrar el componente "${componentName.value}"`)
        }
        
      } catch (err) {
        console.error('Error cargando componente de convenios:', err)

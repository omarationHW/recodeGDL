  ...
  methods: {
    ...
    async selectUsuario(usuario) {
      ...
      try {
        ...
        if (permisosResponse.data?.eResponse?.success && permisosResponse.data?.eResponse?.data) {
          this.permisos = permisosResponse.data.eResponse.data.result
        }
        ...
        if (auditoriaResponse.data?.eResponse?.success && auditoriaResponse.data?.eResponse?.data) {
          this.auditoria = auditoriaResponse.data.eResponse.data.result
        }
      } catch (error) {
    ...
    async loadGlobalAuditoria() {
      try {
        ...
        if (response.data?.eResponse?.success && response.data?.eResponse?.data) {
          this.globalAuditoria = response.data.eResponse.data.result

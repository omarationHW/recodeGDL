    ...
    const loadComponent = async () => {
      ...
      try {
        ...
        if (bestMatch) {
          ...
          try {
            const componentModule = await import(`../../components/modules/otras-oblig/${bestMatch}.vue`)
              ...
              template: `
                <div class="container-fluid mt-4">
                  <div class="alert alert-warning" role="alert">
                    ...
                    <hr>
                    <p class="mb-0">
                      <small>Módulo: Otras Obligaciones | Componente: ${componentName.value}</small>
                    </p>
                  </div>
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between">
                        ...
                        <small class="text-muted">Módulo: Otras Obligaciones</small>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        console.error('Error cargando componente de otras-oblig:', err)

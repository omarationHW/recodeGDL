...
-- Formulario: SQRPTADEUDOS (EXACTO del archivo original)
-- Archivo: 105_SP_ASEO_SQRPTADEUDOS_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================

-- SP 1/1: rpt_adeudos_general
-- Tipo: Report
...
BEGIN
    ...
    RETURN QUERY EXECUTE format('
        ...
        JOIN public.ta_16_pagos H ON H.control_contrato = C.control_contrato

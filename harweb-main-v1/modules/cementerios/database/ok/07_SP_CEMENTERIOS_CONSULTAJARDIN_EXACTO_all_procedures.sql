...
-- Archivo: 07_SP_CEMENTERIOS_CONSULTAJARDIN_EXACTO_all_procedures.sql
-- Generado: 2025-09-09
-- Total SPs: 3 (EXACTO)
-- ============================================
...
-- SP 2/3: consulta_jardin_by_nombre
-- Tipo: Catalog
-- Descripción: Consulta registros de regprop por nombre (LIKE)
-- --------------------------------------------

CREATE OR REPLACE FUNCTION consulta_jardin_by_nombre(nombre varchar)
RETURNS TABLE(
  clase varchar,
  seccion varchar,
  linea varchar,

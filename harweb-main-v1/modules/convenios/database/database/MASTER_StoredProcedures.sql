...
-- SP 2/3 del tipo Catalog
-- Nombre: sp_listar_subtipos_convenio_diversos
...
-- SP 3/3 del tipo Catalog
-- Nombre: sp_listar_tipos_convenio_diversos
...
-- SP 2/8 del tipo CRUD
-- Nombre: sp_bloquear_convenio_diversos
...
-- SP 3/8 del tipo CRUD
-- Nombre: sp_dar_baja_convenio_diversos
...
-- SP 4/8 del tipo CRUD
-- Nombre: sp_dar_pagado_convenio_diversos
...
-- SP 5/8 del tipo CRUD
-- Nombre: sp_delete_tipo
...
-- SP 6/8 del tipo CRUD
-- Nombre: sp_desbloquear_convenio_diversos
...
-- SP 7/8 del tipo CRUD
-- Nombre: sp_modificar_datos_generales_convenio_diversos
...
-- SP 8/8 del tipo CRUD
-- Nombre: sp_update_tipo
...
-- Nombre: sp_buscar_convenio_diversos
...
-- Nombre: sp_individual_diversos_adeudos
...
-- Nombre: sp_individual_diversos_pagos
...
-- Nombre: sp_individual_diversos_referencias
...
-- Nombre: sp_individual_diversos_resumen
...
-- Total de 16 stored procedures incluidos
-- ============================================

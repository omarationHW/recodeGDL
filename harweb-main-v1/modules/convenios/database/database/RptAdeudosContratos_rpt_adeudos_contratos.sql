    ...
    WITH pagos_cte AS (
        SELECT
            ...
            (
                ...
                JOIN ta_17_pagos f ON f.id_convenio = h.id_convenio
                JOIN ta_12_recibosdet g ON g.fecha = f.fecha_pago

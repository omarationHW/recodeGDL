...
-- Formulario: RptAdeudosPrediosSaldoAnt
-- Generado: 2025-08-27 15:28:57
-- Total SPs: 2
-- ============================================

-- SP 1/2: sp_rpt_adeudos_predios_saldo_ant
-- Tipo: Report
...
-- SP 2/2: sp_get_saldo_anterior_predio
-- Tipo: Report
-- Descripción: Obtiene el saldo anterior de un predio antes de una fecha dada
-- --------------------------------------------

-- PostgreSQL stored procedure for saldo anterior
CREATE OR REPLACE FUNCTION sp_get_saldo_anterior_predio(
    p_subtipo integer,

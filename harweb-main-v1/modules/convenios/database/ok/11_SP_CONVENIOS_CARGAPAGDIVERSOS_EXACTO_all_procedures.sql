...
-- Archivo: 11_SP_CONVENIOS_CARGAPAGDIVERSOS_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 2 (EXACTO)
-- ============================================
...
BEGIN
    ...
    FROM public.cg_12_ingreso a
    JOIN public.cg_12_importes b ON a.fecing = b.fecing AND a.recing = b.recing AND a.cajing = b.cajing AND a.opcaja = b.opcaja
...
BEGIN
    ...
    END IF;
    -- Insertar pago
    INSERT INTO public.ta_17_pagos (

...
-- Formulario: PADRONCONVEJEC (EXACTO del archivo original)
-- Archivo: 58_SP_CONVENIOS_PADRONCONVEJEC_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 5 (EXACTO)
-- ============================================
...
BEGIN
  ...
  SELECT 
    ...
    (SELECT SUM(importe_pago) FROM public.ta_17_conv_pagos WHERE id_conv_resto=b.id_conv_resto) as pagos,
    (b.cantidad_total - COALESCE((SELECT SUM(importe_pago) FROM public.ta_17_conv_pagos WHERE id_conv_resto=b.id_conv_resto),0)) as adeudo,

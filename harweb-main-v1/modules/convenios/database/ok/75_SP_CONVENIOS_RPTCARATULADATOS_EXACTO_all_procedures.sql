...
-- Formulario: RPTCARATULADATOS (EXACTO del archivo original)
-- Archivo: 75_SP_CONVENIOS_RPTCARATULADATOS_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 3 (EXACTO)
-- ============================================
...
BEGIN
  ...
  JOIN public.ta_17_colonias b ON a.colonia = b.colonia
  JOIN public.ta_17_servicios c ON a.servicio = c.servicio
  JOIN public.ta_17_tipos d ON a.tipo = d.tipo
  JOIN public.ta_12_passwords e ON a.id_usuario = e.id_usuario
  JOIN public.ta_17_calles f ON a.colonia = f.colonia AND a.calle = f.calle
  LEFT JOIN public.ta_17_hist_conv g ON g.id_convenio = a.id_convenio AND g.clave_historia = 1

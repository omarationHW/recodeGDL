...
-- Formulario: RPTPARCVENCIDASCONVDIVERSOS (EXACTO del archivo original)
-- Archivo: 85_SP_CONVENIOS_RPTPARCVENCIDASCONVDIVERSOS_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================

-- SP 1/1: sp_parcialidades_vencidas_conv_diversos
-- Tipo: Report
...
BEGIN
    ...
    FROM public.ta_17_conv_diverso e
    JOIN public.ta_17_conv_d_resto f ON e.tipo = f.tipo AND e.id_conv_diver = f.id_conv_diver
    ...
    JOIN public.ta_17_tipos j ON e.tipo = j.tipo
    WHERE e.tipo = p_tipo

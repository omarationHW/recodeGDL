...
-- Formulario: SQRP_RELACION_FOLIOS (EXACTO del archivo original)
-- Archivo: 26_SP_ESTACIONAMIENTOS_SQRP_RELACION_FOLIOS_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================

-- SP 1/1: sQRp_relacion_folios_report
-- Tipo: Report

...
-- Formulario: SDMWEBSERVICE (EXACTO del archivo original)
-- Archivo: 29_SP_ESTACIONAMIENTOS_SDMWEBSERVICE_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 2 (EXACTO)
-- ============================================

-- SP 1/2: sp_insert_predio_virtual
-- Tipo: CRUD

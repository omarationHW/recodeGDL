-- Stored Procedure: rep_est_lic_report3
-- Tipo: Report
-- Descripción: Giros reglamentados por zona (clasificación C, D o ambas)
-- Generado para formulario: repEstadisticosLicfrm
-- Fecha: 2025-08-26 17:53:26

CREATE OR REPLACE FUNCTION rep_est_lic_report3(clasificacion TEXT)
RETURNS TABLE(
  id_giro INTEGER,
  descripcion TEXT,
  clasificacion TEXT,

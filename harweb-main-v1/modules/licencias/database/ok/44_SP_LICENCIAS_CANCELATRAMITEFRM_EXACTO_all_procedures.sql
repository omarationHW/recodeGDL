...
-- Formulario: CANCELATRAMITEFRM (EXACTO del archivo original)
-- Archivo: 44_SP_LICENCIAS_CANCELATRAMITEFRM_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 3 (EXACTO)
-- ============================================
...
BEGIN
    ...
    IF v_estatus = 'A' THEN
        ...
        RETURN;
    END IF;
    v_motivo := 'CANCELADO POR PADRON Y public.' || chr(13) || chr(10) || p_motivo;

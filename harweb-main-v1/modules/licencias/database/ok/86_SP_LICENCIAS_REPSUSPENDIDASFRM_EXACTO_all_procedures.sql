...
-- Formulario: REPSUSPENDIDASFRM (EXACTO del archivo original)
-- Archivo: 86_SP_LICENCIAS_REPSUSPENDIDASFRM_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================

-- SP 1/1: report_licencias_suspendidas
-- Tipo: Report

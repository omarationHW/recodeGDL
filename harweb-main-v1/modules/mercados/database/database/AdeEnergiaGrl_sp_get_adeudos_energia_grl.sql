-- Stored Procedure: sp_get_adeudos_energia_grl
-- Tipo: Report
-- Descripción: Obtiene el listado de adeudos generales de energía eléctrica por recaudadora, mercado, año y mes hasta el periodo solicitado.
-- Generado para formulario: AdeEnergiaGrl
-- Fecha: 2025-08-26 19:31:04

CREATE OR REPLACE FUNCTION sp_get_adeudos_energia_grl(
...
BEGIN
    FOR r IN (
        ...
        JOIN ta_11_energia b ON a.id_local = b.id_local
        JOIN ta_11_adeudo_energ c ON b.id_energia = c.id_energia
        JOIN ta_11_mercados d ON a.oficina = d.oficina AND a.num_mercado = d.num_mercado_nvo

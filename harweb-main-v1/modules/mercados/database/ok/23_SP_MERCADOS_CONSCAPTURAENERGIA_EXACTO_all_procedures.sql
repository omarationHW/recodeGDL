...
BEGIN
    ...
    JOIN public.ta_12_passwords u ON p.id_usuario = u.id_usuario
    JOIN public.ta_11_energia e ON p.id_energia = e.id_energia
    JOIN public.ta_11_locales l ON e.id_local = l.id_local
...
BEGIN
    -- Eliminar el pago
    DELETE FROM public.ta_11_pago_energia
...
DECLARE
    v_count INTEGER;
BEGIN
    SELECT COUNT(*) INTO v_count FROM public.ta_11_adeudo_energ
    WHERE id_energia = p_id_energia AND axo = p_axo AND periodo = p_periodo;
    IF v_count = 0 THEN

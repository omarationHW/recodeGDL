...
BEGIN
    ...
    SELECT a.id_local, a.axo, a.periodo, a.importe,
        (a.importe * COALESCE((SELECT SUM(porcentaje_mes) FROM public.ta_12_recargos WHERE axo = a.axo AND mes >= a.periodo),0)/100) AS recargos

...
BEGIN
    ...
    JOIN public.ta_11_locales b ON a.oficina = b.oficina AND a.num_mercado_nvo = b.num_mercado
    JOIN public.ta_11_energia c ON b.id_local = c.id_local
...
BEGIN
    RETURN QUERY SELECT num_mercado_nvo, descripcion FROM public.ta_11_mercados WHERE oficina = p_id_rec AND cuenta_energia > 0 ORDER BY num_mercado_nvo;
END;
$$ LANGUAGE plpgsql;

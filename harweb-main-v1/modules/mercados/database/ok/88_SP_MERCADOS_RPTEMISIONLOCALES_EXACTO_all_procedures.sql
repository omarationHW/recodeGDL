...
BEGIN
    ...
    SELECT
        ...
        (
            ...
            FROM public.ta_11_adeudo_local a2
            JOIN public.ta_12_recargos r ON (r.axo = a2.axo AND r.mes >= a2.periodo)
        ...
        (
            ...
            FROM public.ta_11_adeudo_local a3
    ...
    LEFT JOIN public.ta_11_adeudo_local a ON a.id_local = l.id_local AND ((a.axo = p_axo AND a.periodo < p_periodo) OR (a.axo < p_axo))
...
BEGIN
    ...
    ELSE
        ...
        axo1 := p_axo;
    END IF;
    FOR rec IN SELECT id_local FROM public.ta_11_locales WHERE oficina = p_oficina AND num_mercado = p_mercado AND vigencia = 'A' AND bloqueo < 4
    LOOP
        SELECT COUNT(*) INTO existe FROM public.ta_11_adeudo_local WHERE id_local = rec.id_local AND axo = p_axo AND periodo = p_periodo;
        IF existe = 0 THEN
            -- Calcular renta

...
-- Formulario: GAdeudos_OpcMult_RA (EXACTO del archivo original)
-- Archivo: 09_SP_OTRASOBLIG_GADEUDOS_OPCMULT_RA_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 6 (EXACTO)
-- ============================================
...
BEGIN
  ...
  FROM otrasoblig.ta_12_recaudadoras
  ORDER BY id_rec;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  FROM otrasoblig.ta_12_operaciones

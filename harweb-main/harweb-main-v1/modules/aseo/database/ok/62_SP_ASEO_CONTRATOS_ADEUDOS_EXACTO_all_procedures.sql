...
-- Formulario: CONTRATOS_ADEUDOS (EXACTO del archivo original)
-- Archivo: 62_SP_ASEO_CONTRATOS_ADEUDOS_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================
...
BEGIN
    ...
    INNER JOIN public.ta_16_empresas e ON c.num_empresa = e.num_empresa AND c.ctrol_emp = e.ctrol_emp
    INNER JOIN public.ta_16_tipo_aseo ta ON c.ctrol_aseo = ta.ctrol_aseo
    INNER JOIN public.ta_16_unidades u ON c.ctrol_recolec = u.ctrol_recolec

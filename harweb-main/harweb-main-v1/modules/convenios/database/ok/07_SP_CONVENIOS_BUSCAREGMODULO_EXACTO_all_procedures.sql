...
-- Archivo: 07_SP_CONVENIOS_BUSCAREGMODULO_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 5 (EXACTO)
-- ============================================
...
BEGIN
  ...
  SELECT b.id_multa, a.abrevia, b.axo_acta, b.num_acta, b.contribuyente,
         ...
         b.domicilio
  FROM public.c_dependencias a, public.multas b
...
BEGIN
  ...
  FROM public.convcta e, public.catastro a, public.regprop b, public.contrib c, public.ubicacion d

...
-- Archivo: 22_SP_CONVENIOS_ELABOROMNTTO_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 4 (EXACTO)
-- ============================================
...
BEGIN
    UPDATE public.ta_17_elaboroficio SET
        id_rec = p_id_rec,
...
BEGIN
    ...
    SELECT
        ...
        e.nombre as elabora
    FROM public.ta_12_passwords t
    JOIN public.ta_12_recaudadoras r ON r.id_rec = t.id_rec
    JOIN public.ta_12_passwords e ON e.id_usuario = p_id_usu_elaboro AND e.id_rec = t.id_rec AND e.estado = t.estado

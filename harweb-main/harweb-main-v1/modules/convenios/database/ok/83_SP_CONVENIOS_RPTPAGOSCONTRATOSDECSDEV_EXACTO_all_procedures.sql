...
-- Formulario: RPTPAGOSCONTRATOSDECSDEV (EXACTO del archivo original)
-- Archivo: 83_SP_CONVENIOS_RPTPAGOSCONTRATOSDECSDEV_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================
...
BEGIN
    ...
    JOIN public.ta_17_pagos b ON a.id_convenio = b.id_convenio

...
-- Archivo: 95_SP_CONVENIOS_DEUDAGRUPO_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================
...
BEGIN
    ...
    FOR r IN
        SELECT c.axo_obra as obra, a.id_convenio, a.colonia, a.calle, a.folio, a.nombre, a.pago_total, a.fecha_vencimiento,
               ...
               (SELECT COALESCE(SUM(g.importe),0) FROM public.ta_17_convenios h, ta_17_pagos f, ta_12_recibosdet g

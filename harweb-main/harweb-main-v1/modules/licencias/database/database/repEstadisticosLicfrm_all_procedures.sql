...
-- Formulario: repEstadisticosLicfrm
-- Generado: 2025-08-27 19:20:47
-- Total SPs: 5
-- ============================================
...
-- Tipo: Report
-- Descripción: Reporte de licencias vigentes agrupadas por giro y zona.
-- --------------------------------------------

CREATE OR REPLACE FUNCTION sp_rep_estadisticos_lic_giro_zona()
RETURNS TABLE(
    id_giro INTEGER,
    descripcion TEXT,
    z_1 INTEGER,

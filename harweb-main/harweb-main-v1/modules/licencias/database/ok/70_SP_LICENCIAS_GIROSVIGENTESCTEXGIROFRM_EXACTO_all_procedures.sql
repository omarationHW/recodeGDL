...
-- Formulario: GIROSVIGENTESCTEXGIROFRM (EXACTO del archivo original)
-- Archivo: 70_SP_LICENCIAS_GIROSVIGENTESCTEXGIROFRM_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 1 (EXACTO)
-- ============================================

-- SP 1/1: sp_reporte_giros_vigentes_cte_xgiro
-- Tipo: Report
...
BEGIN
    v_sql := 'SELECT COUNT(l.licencia) AS cuantos, l.id_giro, g.cod_giro, g.descripcion '
           || 'FROM public l JOIN c_giros g ON g.id_giro = l.id_giro '
           || 'WHERE l.vigente = $1';

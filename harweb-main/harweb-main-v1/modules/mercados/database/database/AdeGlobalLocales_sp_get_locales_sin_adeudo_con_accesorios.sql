-- Stored Procedure: sp_get_locales_sin_adeudo_con_accesorios
-- Tipo: Report
...
BEGIN
    ...
    SELECT 
        ...
        COALESCE((SELECT SUM(CASE WHEN r.vigencia = '1' AND r.clave_practicado = 'P' THEN r.importe_multa ELSE 0 END) FROM ta_15_apremios r WHERE r.modulo = 11 AND r.control_otr = a.id_local), 0) AS multas,
    ...
    LEFT JOIN ta_11_adeudo_local b ON a.id_local = b.id_local AND ((b.axo = p_year AND b.periodo <= p_month) OR (b.axo < p_year2))

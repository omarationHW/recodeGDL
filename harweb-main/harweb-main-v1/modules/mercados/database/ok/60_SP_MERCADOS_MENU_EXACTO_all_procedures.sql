...
BEGIN
    ...
    JOIN public.ta_11_locales c ON a.id_energia = f.id_energia AND c.id_local = f.id_local
    JOIN public.ta_11_energia f ON a.id_energia = f.id_energia
    JOIN public.ta_11_mercados d ON c.oficina = d.oficina AND c.num_mercado = d.num_mercado_nvo
    WHERE a.axo = p_axo

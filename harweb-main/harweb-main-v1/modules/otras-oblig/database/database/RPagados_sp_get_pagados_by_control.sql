-- Stored Procedure: sp_get_pagados_by_control
-- Tipo: Report
-- Descripción: Obtiene los pagos realizados (pagados) para un id_datos (control) específico, filtrando por status permitido.
-- Generado para formulario: RPagados
-- Fecha: 2025-08-27 14:21:19

CREATE OR REPLACE FUNCTION sp_get_pagados_by_control(p_control integer)
RETURNS TABLE (
    id_34_pagos integer,
    id_datos integer,
    periodo date,

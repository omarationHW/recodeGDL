...
-- Formulario: AplicaSdosFavor
-- Generado: 2025-08-26 20:42:04
-- Total SPs: 1
-- ============================================
...
BEGIN
    ...
    FROM public.sdosfavor WHERE id_solic = p_id_solic;
    ...
    INSERT INTO public.pagos (cvecuenta, fecha, importe, capturista, cveconcepto)
    ...
    UPDATE public.detsaldos SET imppag = imppag + p_importe
    ...
    INSERT INTO public.pagosapl_sdosfavor (id_solic, impuesto, recargos, feccap, capturista, cvecuenta, bimi, axoi, bimf, axof)

...
-- Formulario: PRUEBA (EXACTO del archivo original)
-- Archivo: 90_SP_ASEO_PRUEBA_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 2 (EXACTO)
-- ============================================
...
BEGIN
  ...
  IF EXISTS (
    SELECT 1 FROM public.ta_16_rel_licgiro rl
    JOIN public.ta_16_contratos c ON c.control_contrato = rl.control_contrato

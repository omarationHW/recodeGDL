...
-- Archivo: 03_SP_CONVENIOS_ACTUALIZADEVOLUCION_EXACTO_all_procedures.sql
-- Generado: 2025-09-09
-- Total SPs: 2 (EXACTO)
-- ============================================
...
-- SP 2/2: sp_find_contrato_by_col_calle_fol
-- Tipo: Catalog
...
BEGIN
    RETURN QUERY SELECT id_convenio FROM public.ta_17_convenios WHERE colonia = p_col AND calle = p_calle AND folio = p_fol;
END;
$$ LANGUAGE plpgsql;

...
-- Formulario: SFRM_TRANS_PUB (EXACTO del archivo original)
-- Archivo: 42_SP_ESTACIONAMIENTOS_SFRM_TRANS_PUB_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 2 (EXACTO)
-- ============================================
...
BEGIN
    ...
    END IF;
    INSERT INTO public.ta_15_publicos (

-- Stored Procedure: sp_ade_energia_grl
-- Tipo: Report
...
BEGIN
    ...
    LOOP
        ...
        meses := '';
        cuota_val := 0;
        FOR m IN SELECT periodo, importe FROM ta_11_adeudo_energ WHERE id_energia = r.id_energia AND (axo = p_axo AND periodo <= p_mes) ORDER BY periodo LOOP

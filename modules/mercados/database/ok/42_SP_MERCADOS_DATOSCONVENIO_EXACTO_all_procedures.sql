...
BEGIN
  ...
  FROM public.ta_17_referencia a
    JOIN public.ta_17_conv_d_resto b ON b.id_conv_resto = a.id_conv_resto
    JOIN public.ta_17_adeudos_div c ON c.id_conv_resto = a.id_conv_resto
    LEFT JOIN public.ta_17_conv_pagos d ON d.id_conv_resto = c.id_conv_resto AND d.pago_parcial = c.pago_parcial
    JOIN public.ta_17_conv_diverso e ON e.tipo = b.tipo AND e.id_conv_diver = b.id_conv_diver
    JOIN public.ta_17_tipos f ON f.tipo = e.tipo
    JOIN public.ta_17_subtipo_conv g ON g.tipo = e.tipo AND g.subtipo = e.subtipo
...
-- SP 2/3: sp_get_convenio_parciales
-- Tipo: Report
...
-- SP 3/3: sp_get_convenio_resumen
-- Tipo: Report

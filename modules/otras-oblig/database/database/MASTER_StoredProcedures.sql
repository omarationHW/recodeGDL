...
-- SP 1/31 del tipo Catalog
-- Nombre: buscar_concesion
...
-- SP 2/31 del tipo Catalog
-- Nombre: get_concesion_by_control
...
-- SP 3/31 del tipo Catalog
-- Nombre: get_fecha_limite
...
-- SP 4/31 del tipo Catalog
-- Nombre: ins34_rubro_01
...
-- SP 6/31 del tipo Catalog
-- Nombre: sp_gadeudos_etiquetas
...
-- SP 7/31 del tipo Catalog
-- Nombre: sp_gadeudos_tablas
...
-- SP 8/31 del tipo Catalog
-- Nombre: sp_gconsulta2_get_etiquetas
...
-- SP 9/31 del tipo Catalog
-- Nombre: sp_gconsulta2_get_tablas
...
-- SP 10/31 del tipo Catalog
-- Nombre: sp_get_apremios
...
-- SP 12/31 del tipo Catalog
-- Nombre: sp_get_etiquetas
...
-- SP 14/31 del tipo Catalog
-- Nombre: sp_get_periodos_by_control
...
-- SP 16/31 del tipo Catalog
-- Nombre: sp_get_tabla_info
...
-- SP 17/31 del tipo Catalog
-- Nombre: sp_get_tablas
...
-- SP 18/31 del tipo Catalog
-- Nombre: sp_menu_get_ejercicios
...
-- SP 19/31 del tipo Catalog
-- Nombre: sp_menu_get_menu
...
-- SP 20/31 del tipo Catalog
-- Nombre: sp_menu_get_user_info
...
-- SP 21/31 del tipo Catalog
-- Nombre: sp_rbaja_buscar_local
...
-- SP 23/31 del tipo Catalog
-- Nombre: sp34_etiq_tabla
...
-- SP 24/31 del tipo Catalog
-- Nombre: sp34_nombre_tabla
...
-- SP 26/31 del tipo Catalog
-- Nombre: sp34_vigencias
...
-- SP 27/31 del tipo Catalog
-- Nombre: sp34_vigencias_concesion
...
-- SP 30/31 del tipo Catalog
-- Nombre: ta_12_operaciones
...
-- SP 31/31 del tipo Catalog
-- Nombre: ta_12_recaudadoras
...
-- SP 1/20 del tipo CRUD
-- Nombre: actualizar_concesion
...
-- SP 3/20 del tipo CRUD
-- Nombre: sp_create_apremio
...
-- SP 4/20 del tipo CRUD
-- Nombre: sp_delete_apremio
...
-- SP 5/20 del tipo CRUD
-- Nombre: sp_gconsulta2_busca_coincide
...
-- SP 6/20 del tipo CRUD
-- Nombre: sp_gconsulta2_busca_cont
...
-- SP 7/20 del tipo CRUD
-- Nombre: sp_get_datos_concesion
...
-- SP 8/20 del tipo CRUD
-- Nombre: sp_gnuevos_alta
...
-- SP 9/20 del tipo CRUD
-- Nombre: sp_ins34_rastro_01
...
-- SP 10/20 del tipo CRUD
-- Nombre: sp_insert_t34_unidades
...
-- SP 11/20 del tipo CRUD
-- Nombre: sp_menu_check_version
...
-- SP 12/20 del tipo CRUD
-- Nombre: sp_menu_login
...
-- SP 13/20 del tipo CRUD
-- Nombre: sp_rbaja_cancelar_local
...
-- SP 14/20 del tipo CRUD
-- Nombre: sp_rbaja_verificar_adeudos
...
-- SP 15/20 del tipo CRUD
-- Nombre: sp_rbaja_verificar_adeudos_post
...
-- SP 16/20 del tipo CRUD
-- Nombre: sp_update_apremio
...
-- SP 17/20 del tipo CRUD
-- Nombre: sp_update_t34_etiq
...
-- SP 19/20 del tipo CRUD
-- Nombre: upd34_gen_adeudos_ind
...
-- SP 20/20 del tipo CRUD
-- Nombre: verificar_pagos
...
-- SP 1/23 del tipo Report
-- Nombre: cob34_gdatosg_02
...
-- SP 2/23 del tipo Report
-- Nombre: cob34_gdetade_01
...
-- SP 5/23 del tipo Report
-- Nombre: con34_1detade_02
...
-- SP 6/23 del tipo Report
-- Nombre: con34_gcont_01
...
-- SP 7/23 del tipo Report
-- Nombre: con34_gdetade_01
...
-- SP 9/23 del tipo Report
-- Nombre: con34_rdetade_021
...
-- SP 10/23 del tipo Report
-- Nombre: get_adeudos_by_concesion
...
-- SP 11/23 del tipo Report
-- Nombre: get_pagados_by_concesion
...
-- SP 12/23 del tipo Report
-- Nombre: get_totales_by_concesion
...
-- SP 13/23 del tipo Report
-- Nombre: sp_con34_gfact_02
...
-- SP 14/23 del tipo Report
-- Nombre: sp_gadeudos_busca
...
-- SP 15/23 del tipo Report
-- Nombre: sp_gadeudos_detalle
...
-- SP 16/23 del tipo Report
-- Nombre: sp_gconsulta2_busca_adeudos
...
-- SP 17/23 del tipo Report
-- Nombre: sp_gconsulta2_busca_pagados
...
-- SP 18/23 del tipo Report
-- Nombre: sp_gconsulta2_busca_totales
...
-- SP 19/23 del tipo Report
-- Nombre: sp_get_pagados
...
-- SP 21/23 del tipo Report
-- Nombre: sp34_adeudototal
...
-- Total de 74 stored procedures incluidos
-- ============================================

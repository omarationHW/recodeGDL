...
-- Formulario: GFacturacion (EXACTO del archivo original)
-- Archivo: 13_SP_OTRASOBLIG_GFACTURACION_EXACTO_all_procedures.sql
-- Generado: 2025-09-10
-- Total SPs: 3 (EXACTO)
-- ============================================
...
BEGIN
    ...
    JOIN otrasoblig.t34_unidades u ON d.cve_tab = u.cve_tab
    JOIN otrasoblig.t34_adeudos a ON d.id_34_datos = a.id_datos

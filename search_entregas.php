<?php
// Script para buscar tablas relacionadas con entregas
...
try {
    ...
    // 1. Buscar tablas con patrones relacionados a entregas
    echo "=== BUSCANDO TABLAS RELACIONADAS CON ENTREGAS ===\n\n";
    ...
    echo "Buscando tablas que contengan campos relacionados con entregas\n\n";
    ...
    $stmt = $pdo->query("
        ...
        AND (
            LOWER(c.column_name) IN ('folio', 'fecent', 'fecha_entrega', 'recibereq', 'recibe', 'entrego', 'fecprac', 'fecha_practica')
            OR c.column_name ILIKE '%entrega%'
            OR c.column_name ILIKE '%recib%'
            OR c.column_name ILIKE '%dilig%'
        )

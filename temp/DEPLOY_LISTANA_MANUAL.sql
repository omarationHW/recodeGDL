-- ================================================================
-- DESPLIEGUE MANUAL: recaudadora_listana
...
-- EJEMPLO 1: Sin filtro (primeros 10 registros)
-- Uso: Ver las multas más recientes
SELECT * FROM db_ingresos.recaudadora_listana('', 0, 10);

-- EJEMPLO 2: Buscar por año 2024
-- Uso: Ver multas de un año específico
SELECT * FROM db_ingresos.recaudadora_listana('2024', 0, 10);

-- EJEMPLO 3: Buscar por nombre de contribuyente
-- Uso: Buscar multas por nombre (por ejemplo "MARIA")
SELECT * FROM db_ingresos.recaudadora_listana('MARIA', 0, 10);

-- EJEMPLO 4: Paginación - Segunda página
-- Uso: Ver registros 11-20 sin filtro
SELECT * FROM db_ingresos.recaudadora_listana('', 10, 10);

-- EJEMPLO 5: Buscar por domicilio
-- Uso: Buscar multas por ubicación (por ejemplo "MEXICO")
SELECT * FROM db_ingresos.recaudadora_listana('MEXICO', 0, 10);

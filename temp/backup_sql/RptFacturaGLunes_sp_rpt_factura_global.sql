...
BEGIN
    ...
    FROM
        padron_licencias.comun.ta_11_mercados m
    LEFT JOIN
        padron_licencias.comun.ta_11_locales l ON l.oficina = m.id_rec AND l.mercado = m.num_mercado_nvo
    LEFT JOIN
        padron_licencias.comun.ta_11_pagos_local pl ON pl.id_local = l.id_local
            AND pl.axo = p_axo

#!/usr/bin/env python3
"""
Script para convertir el documento Markdown a Word (.docx)
...
if __name__ == '__main__':
    ...
    md_file = os.path.join(project_root, 'DIAGRAMAS_ER_DICCIONARIO_DATOS_VERIFICADO.md')
    output_file = os.path.join(project_root, 'DIAGRAMAS_ER_DICCIONARIO_DATOS_VERIFICADO.docx')

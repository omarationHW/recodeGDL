<?php
/**
 * Desplegar recaudadora_ligapago en la base de datos
 */
...
$sqlFile = __DIR__ . '/../RefactorX/Base/multas_reglamentos/database/generated/recaudadora_ligapago.sql';
...
try {
    ...
    echo "📄 Desplegando SP recaudadora_ligapago...\n\n";
    ...
    if ($sp) {
        ...
        // Probar con cuenta de ejemplo
        echo "🧪 Probando con cuenta 358307...\n\n";

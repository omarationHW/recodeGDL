-- ========================================
-- DESPLIEGUE CORREGIDO: DatosRequerimientos
...
-- SP 1/4: sp_get_locales (CORREGIDO)
...
SELECT 'SP 1/4: sp_get_locales creado (CHAR corregido)' as status;
...
SELECT '========================================' as status;
SELECT 'DESPLIEGUE COMPLETADO EN padron_licencias' as status;
SELECT '========================================' as status;

-- Probar sp_get_locales
SELECT 'Probando sp_get_locales(1)...' as status;

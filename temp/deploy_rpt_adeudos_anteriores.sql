-- ============================================================
-- DESPLIEGUE DE SP CORREGIDO PARA RptAdeudosAnteriores
-- Fecha: 2025-12-04
-- Problema: Tablas sin schema + parámetros incorrectos
-- ============================================================

DROP FUNCTION IF EXISTS public.rpt_adeudos_anteriores(INTEGER, INTEGER, INTEGER);

CREATE OR REPLACE FUNCTION public.rpt_adeudos_anteriores(p_axo INTEGER, p_oficina INTEGER, p_periodo INTEGER)
RETURNS TABLE(
    id_local INTEGER,
    oficina SMALLINT,
...
COMMENT ON FUNCTION public.rpt_adeudos_anteriores(INTEGER, INTEGER, INTEGER) IS
'Obtiene el listado de adeudos anteriores a 1996 para mercados, agrupando por local y año';

            ...
            <table class="municipal-table">
              <thead class="municipal-table-header">
                <tr>
                  ...
                  <th style="width: 8%; text-align: right;">Área Útil (m²)</th>
                  <th style="width: 5%; text-align: center;">Cajones</th>
                  <th style="width: 7%; text-align: center;">Zona/Subzona</th>
                  <th style="width: 8%; text-align: center;">Dictamen</th>
              ...
              <tbody>
                ...
                <tr v-else v-for="dictamen in dictamenes" :key="dictamen.id_dictamen" class="row-hover">
                  ...
                  <td style="text-align: right;">{{ dictamen.area_util ? dictamen.area_util.toFixed(2) : '0.00' }}</td>
                  <td style="text-align: center;">{{ dictamen.num_cajones || 0 }}</td>
                  <td style="text-align: center;">{{ dictamen.zona }}/{{ dictamen.subzona }}</td>
                  <td style="text-align: center;">
                    <span class="badge" :class="getDictamenBadgeClass(dictamen.dictamen)">
                      {{ getDictamenText(dictamen.dictamen) }}
                    </span>
                  </td>
                  <td style="text-align: center;">{{ formatDate(dictamen.fecha) }}</td>
                  <td style="text-align: center;">
                    <div class="btn-group-actions">
                      <button
        ...
        <div class="modal-section">
          ...
          <div class="modal-grid-3">
            <div class="detail-item">
              ...
              <span class="badge bg-primary">{{ selectedDictamen.id_dictamen }}</span>
            </div>
            <div class="detail-item">
              <label>ID Giro:</label>
              <span class="badge bg-info">{{ selectedDictamen.id_giro || 'N/A' }}</span>
            </div>
            <div class="detail-item">
              <label>Capturista:</label>
              <span>{{ trimString(selectedDictamen.capturista) || 'N/A' }}</span>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
              ...
              <span class="badge bg-secondary">{{ selectedDictamen.zona }}/{{ selectedDictamen.subzona }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="modal-section">
          ...
          <div class="modal-grid-3">
            <div class="detail-item">
              ...
              <span class="badge badge-light-info">{{ selectedDictamen.supconst ? selectedDictamen.supconst.toFixed(2) : '0.00' }} m²</span>
            </div>
            <div class="detail-item">
              <label>Área Útil:</label>
              <span class="badge badge-light-success">{{ selectedDictamen.area_util ? selectedDictamen.area_util.toFixed(2) : '0.00' }} m²</span>
            </div>
            <div class="detail-item">
              <label>Número de Cajones:</label>
              <span class="badge badge-light-warning">{{ selectedDictamen.num_cajones || 0 }}</span>
            </div>
          </div>
        </div>

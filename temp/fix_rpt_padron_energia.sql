-- ============================================
-- FIX: rpt_padron_energia - Corregir referencia cross-database
-- Problema: JOIN mercados.public.ta_11_energia (cross-database no soportado)
...
BEGIN
    ...
    JOIN padron_licencias.db_ingresos.ta_11_energia c  -- ✅ Corregido: usar schema correcto
        ON b.id_local = c.id_local
    WHERE a.oficina = p_oficina
      AND a.num_mercado_nvo = p_mercado
      -- Sin filtro de vigencia para ver todos los registros

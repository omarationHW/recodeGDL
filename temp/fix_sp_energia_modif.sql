-- ============================================
-- FIX: SPs de EnergiaModif - Corregir cross-database references
-- Problema: Referencias a mercados.public.ta_11_energia
-- Solución: Usar padron_licencias.db_ingresos.ta_11_energia
-- Fecha: 2025-12-04
-- ============================================
...
BEGIN
    ...
    INNER JOIN padron_licencias.db_ingresos.ta_11_energia e  -- ✅ Corregido
...
BEGIN
    ...
    SELECT * INTO v_old
    FROM padron_licencias.db_ingresos.ta_11_energia  -- ✅ Corregido
    ...
    INSERT INTO padron_licencias.db_ingresos.ta_11_energia_hist (  -- ✅ Corregido
    ...
    -- Actualizar energía
    UPDATE padron_licencias.db_ingresos.ta_11_energia  -- ✅ Corregido
    SET
    ...
    IF v_mov = 'B' THEN
        ...
        DELETE FROM padron_licencias.db_ingresos.ta_11_adeudo_energ  -- ✅ Corregido
    ...
    ELSIF v_mov = 'F' THEN
        ...
        WHILE v_date <= v_end LOOP
            ...
            INSERT INTO padron_licencias.db_ingresos.ta_11_adeudo_energ (  -- ✅ Corregido
    ...
    ELSIF v_mov = 'D' THEN
        ...
        UPDATE padron_licencias.db_ingresos.ta_11_adeudo_energ  -- ✅ Corregido

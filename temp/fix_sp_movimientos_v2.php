...
echo "=== Corrigiendo SP de Movimientos (v2) ===\n\n";
...
// Verificar estructura de ta_11_localpaso
echo "=== Estructura de ta_11_localpaso ===\n";
$stmt = $pdo->query("SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'ta_11_localpaso' ORDER BY ordinal_position");
...
// Crear la función corregida usando ta_11_localpaso
$sql = <<<'SQL'
...
BEGIN
    ...
    SELECT
        ...
        a.sector,
        a.zona,
        a.drescripcion_local::VARCHAR(60) as descripcion_local,
        a.superficie,
        a.giro,
        a.fecha_alta,
        a.fecha_baja,
    ...
    LEFT JOIN ta_11_localpaso c ON c.id_local = a.id_local
...
echo "\n=== Probando sp_get_movimientos_by_local(6114) ===\n";
try {
    $stmt = $pdo->query("SELECT * FROM sp_get_movimientos_by_local(6114) LIMIT 3");

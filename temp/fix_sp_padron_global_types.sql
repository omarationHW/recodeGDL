-- Stored Procedure: sp_padron_global con tipos de datos corregidos
...
RETURNS TABLE (
    ...
    categoria smallint,
    seccion char(2),              -- Cambiado de varchar(2) a char(2)
    local smallint,
    letra_local varchar(3),       -- Cambiado de varchar(1) a varchar(3)
    bloque varchar(2),
    nombre varchar(30),
    descripcion_local char(20),   -- Cambiado de varchar a char(20)
    superficie numeric,
    vigencia char(1),             -- Cambiado de varchar(1) a char(1)

...
echo "=== Verificando estructura de db_ingresos.ta_11_energia ===\n\n";

$stmt = $pdo->query("
    SELECT column_name, data_type
    FROM information_schema.columns
    WHERE table_schema = 'db_ingresos' AND table_name = 'ta_11_energia'
    ORDER BY ordinal_position
");
$cols = $stmt->fetchAll(PDO::FETCH_ASSOC);
echo "Columnas de db_ingresos.ta_11_energia:\n";
foreach ($cols as $c) {
    echo "  {$c['column_name']} ({$c['data_type']})\n";
}

echo "\n=== Corrigiendo SPs para ConsPagosEnergia (schema db_ingresos) ===\n\n";

// SP 1: Buscar pagos energia por local
...
BEGIN
    ...
    JOIN db_ingresos.ta_11_energia e ON e.id_local = l.id_local
...
// SP 2: Buscar pagos energia por fecha
...
BEGIN
    ...
    JOIN db_ingresos.ta_11_energia e ON p.id_energia = e.id_energia

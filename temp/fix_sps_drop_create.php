...
echo "=== Recreando SPs de CuotasMdo ===\n\n";
...
$drops = [
    "DROP FUNCTION IF EXISTS sp_cuotasmdo_list(integer)",
    "DROP FUNCTION IF EXISTS sp_categorias_list()",
    "DROP FUNCTION IF EXISTS sp_secciones_list()",
    "DROP FUNCTION IF EXISTS sp_clavescuota_list()",
    "DROP FUNCTION IF EXISTS sp_cuotasmdo_create(integer,integer,varchar,integer,numeric,integer)",
    "DROP FUNCTION IF EXISTS sp_cuotasmdo_create(smallint,smallint,char,smallint,numeric,integer)",
    "DROP FUNCTION IF EXISTS sp_cuotasmdo_update(integer,integer,integer,varchar,integer,numeric,integer)",
    "DROP FUNCTION IF EXISTS sp_cuotasmdo_update(integer,smallint,smallint,char,smallint,numeric,integer)",
    "DROP FUNCTION IF EXISTS sp_cuotasmdo_delete(integer)"
];
...
try {
    $stmt = $pdo->query("SELECT * FROM sp_cuotasmdo_list(2020) LIMIT 3");

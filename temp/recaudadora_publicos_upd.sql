...
--   Formato: [{"cveconcepto": 1, "descripcion": "...", "ncorto": "...", "cvegrupo": 1}]
-- ================================================================
...
BEGIN
    ...
    LOOP
        ...
        IF v_exists THEN
            ...
            UPDATE public.c_conceptos
            SET
                descripcion = v_descripcion,
                ncorto = COALESCE(v_ncorto, ncorto),
                cvegrupo = v_cvegrupo,
                feccap = CURRENT_DATE,
                capturista = 'SISTEMA'
            WHERE cveconcepto = v_cveconcepto;
        ...
        ELSE
            ...
            IF v_cveconcepto = 0 THEN
                ...
                SELECT COALESCE(MAX(cveconcepto), 0) + 1
                INTO v_cveconcepto
                FROM public.c_conceptos;
            END IF;
            ...
            INSERT INTO public.c_conceptos (
                ...
                v_cveconcepto,
                v_descripcion,
                COALESCE(v_ncorto, SUBSTRING(v_descripcion, 1, 15)),
                CURRENT_DATE,
                'SISTEMA',
                v_cvegrupo
            );
            ...
            SELECT
                v_cveconcepto,
                v_descripcion,
                COALESCE(v_ncorto, SUBSTRING(v_descripcion, 1, 15)::TEXT),
                v_cvegrupo,
                'INSERTADO'::TEXT,

-- ================================================================
-- SP: recaudadora_rep_desc_impto
-- Módulo: multas_reglamentos
-- Descripción: Reporte de descuento de impuestos (multas) por dependencia por ejercicio
-- Parámetros:
--   p_ejercicio: Año del ejercicio (requerido)
-- ================================================================

DROP FUNCTION IF EXISTS public.recaudadora_rep_desc_impto(INTEGER);

CREATE OR REPLACE FUNCTION public.recaudadora_rep_desc_impto(
    p_ejercicio INTEGER
)
RETURNS TABLE (
...
COMMENT ON FUNCTION public.recaudadora_rep_desc_impto(INTEGER) IS 'Reporte de descuento de impuestos (multas) por dependencia por ejercicio';

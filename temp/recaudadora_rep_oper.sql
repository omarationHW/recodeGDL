-- ================================================================
-- SP: recaudadora_rep_oper
-- Módulo: multas_reglamentos
-- Descripción: Reporte de operaciones de multas por rango de fechas
-- Parámetros:
--   p_desde: Fecha inicial (requerido)
--   p_hasta: Fecha final (requerido)
-- ================================================================

DROP FUNCTION IF EXISTS public.recaudadora_rep_oper(DATE, DATE);

CREATE OR REPLACE FUNCTION public.recaudadora_rep_oper(
    p_desde DATE,
    p_hasta DATE
)
RETURNS TABLE (
...
COMMENT ON FUNCTION public.recaudadora_rep_oper(DATE, DATE) IS 'Reporte de operaciones de multas por rango de fechas';

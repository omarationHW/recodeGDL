<?php
/**
 * Verificar si existen folios de prueba en reqdiftransmision
...
try {
    ...
    echo "🔍 Verificando folios en reqdiftransmision...\n\n";
    ...
    echo "\n⚠️ Faltan " . count($faltantes) . " folios. ¿Desea crearlos? (continuando automáticamente...)\n\n";

    // Verificar estructura de la tabla
    echo "🔍 Verificando estructura de reqdiftransmision...\n";
    $columns = $pdo->query("
    ...
    // Crear folios faltantes con valores mínimos necesarios
    ...
    echo "  - Folios existentes: " . (count($foliosPrueba) - count($faltantes)) . "\n";

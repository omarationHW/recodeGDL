<?php
// Verificar la estructura de la tabla public.pagoscan
...
try {
    ...
    echo "=== ESTRUCTURA DE public.pagoscan ===\n\n";
    ...
    $stmt = $pdo->query("SELECT * FROM public.pagoscan LIMIT 3");
    ...
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM public.pagoscan");

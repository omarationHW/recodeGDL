<?php
// Verificar la estructura de la tabla public.parametros
...
try {
    ...
    echo "=== ESTRUCTURA DE public.parametros ===\n\n";
    ...
    $stmt = $pdo->query("SELECT * FROM public.parametros");
    ...
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM public.parametros");
